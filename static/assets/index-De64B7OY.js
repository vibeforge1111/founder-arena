...
`)+`
`+f);const x=y+g+o,v=y+f+a,C=Rl(i,i.VERTEX_SHADER,x),w=Rl(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(P){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),U=i.getShaderInfoLog(C).trim(),$=i.getShaderInfoLog(w).trim();let q=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,w);else{const Z=Ll(i,C,"vertex"),G=Ll(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`)}_buildReplayEmbedSnippet(e,t="Founder Arena Featured Replay"){return e?`<iframe src="${e}" title="${t}" width="720" height="900" style="width:100%;max-width:720px;height:900px;border:0;border-radius:16px;overflow:hidden;" loading="lazy"></iframe>`:""}_syncReplayLayoutChrome(e){var d;const t=this._isFeaturedReplayPage(e),n=this._isReplayCardLayout(e),i=this._isReplaySocialLayout(e)||((d=e.entryContext)==null?void 0:d.layout)==="social",s=this._isFeaturedSlotPage(e),o=t||s;this.rankings.el.style.display=o?"none":"",this.timeline._wrapper.style.display=o?"none":"",this.detail.el.style.display=o?"none":"";const a=this._header.querySelector("#btn-quick-play"),l=this._header.querySelector("#btn-new-game"),c=this._header.querySelector("#btn-watch");[a,l,c].forEach(h=>{h&&(h.style.display=n||i?"none":"")})}_updateDiscoveryShelf(e){if(!!(e.gameId||e.gameData)||this._isFeaturedSlotPage(e)){this._discoveryShelf.classList.add("hidden"),this._discoveryShelf.innerHTML="";return}const n=Array.isArray(e.games)?e.games:[],i=e.leaderboardData||{},s=e.featuredFeed||{},o=(s.live_now||[]).length>0?s.live_now:n.filter(m=>m.phase==="playing").sort((m,_)=>(_.turn||0)-(m.turn||0)).slice(0,3),a=(s.featured_replays||[]).length>0?(s.featured_replays||[]).slice(0,4):[];if(a.length===0){for(const m of i.leaderboard||[])if(!(m.game_mode!=="competitive_mode"||!m.was_winner)&&!a.some(_=>_.game_id===m.game_id)&&(a.push(m),a.length>=4))break}const l=(i.agent_rankings||[]).slice(0,5),c=[{label:"Daily Featured Duel",accent:"#FFB800",item:s.daily_featured_duel,mode:"slot",slot:"daily_featured_duel"},{label:"Weekly Upset Recap",accent:"#A78BFA",item:s.weekly_upset_recap,mode:"slot",slot:"weekly_upset_recap"},{label:"Beat This Benchmark",accent:"#22D3EE",item:s.benchmark_challenge,mode:"slot",slot:"benchmark_challenge"}];if(o.length===0&&a.length===0&&l.length===0&&!c.some(m=>m.item)){this._discoveryShelf.classList.add("hidden"),this._discoveryShelf.innerHTML="";return}const d=o.length>0?o.map(m=>`
        ...
        `).join(""):'<div style="font-size:10px;color:var(--text-muted)">Leaderboard is still warming up.</div>',p=c.map(m=>{var _;return m.item?`
        <button class="btn-clean discovery-link" data-mode="${m.mode}" data-slot="${m.slot}" data-game="${m.item.game_id}" data-spectator="${m.item.spectator_token||""}" style="text-align:left;padding:12px 14px;border-color:${m.accent}2e;background:${m.accent}12">
          ...
          ${(_=m.item.artifact_focus)!=null&&_.label?`<div style="font-size:8px;color:#FCD34D;font-weight:800;letter-spacing:0.7px;text-transform:uppercase;margin-top:8px">${m.item.artifact_focus.label}</div>`:""}
    ...
    `;const y=this._featuredReplayPage.querySelector("#featured-open-recap"),x=this._featuredReplayPage.querySelector("#featured-copy-link"),v=this._featuredReplayPage.querySelector("#featured-copy-card-link"),C=this._featuredReplayPage.querySelector("#featured-copy-social-link"),w=this._featuredReplayPage.querySelector("#featured-copy-embed"),T=this._featuredReplayPage.querySelector("#featured-copy-headline"),R=this._featuredReplayPage.querySelector("#featured-copy-caption"),S=this._featuredReplayPage.querySelector("#featured-copy-social-caption"),M=this._featuredReplayPage.querySelector("#featured-copy-package"),P=this._featuredReplayPage.querySelector("#featured-copy-recap");y==null||y.addEventListener("click",()=>{this.controls.showPostGame({entryMode:"sharedReplay"})}),x==null||x.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(d||""),this._copyButtonFeedback(x,"Copy Link","Link Copied")}catch{this._copyButtonFeedback(x,"Copy Link","Copy Failed")}}),v==null||v.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h||""),this._copyButtonFeedback(v,"Copy Card Link","Card Link Copied")}catch{this._copyButtonFeedback(v,"Copy Card Link","Copy Failed")}}),C==null||C.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(u||""),this._copyButtonFeedback(C,"Copy Social Link","Social Link Copied")}catch{this._copyButtonFeedback(C,"Copy Social Link","Copy Failed")}}),w==null||w.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_||""),this._copyButtonFeedback(w,"Copy Embed","Embed Copied")}catch{this._copyButtonFeedback(w,"Copy Embed","Copy Failed")}}),T==null||T.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(p.headline||""),this._copyButtonFeedback(T,"Copy Headline","Headline Copied")}catch{this._copyButtonFeedback(T,"Copy Headline","Copy Failed")}}),R==null||R.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(p.caption||""),this._copyButtonFeedback(R,"Copy Caption","Caption Copied")}catch{this._copyButtonFeedback(R,"Copy Caption","Copy Failed")}}),S==null||S.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(g||""),this._copyButtonFeedback(S,"Copy Social Caption","Social Caption Copied")}catch{this._copyButtonFeedback(S,"Copy Social Caption","Copy Failed")}}),M==null||M.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(p.featuredCard||""),this._copyButtonFeedback(M,"Copy Package","Package Copied")}catch{this._copyButtonFeedback(M,"Copy Package","Copy Failed")}}),P==null||P.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(m||""),this._copyButtonFeedback(P,"Copy Recap","Recap Copied")}catch{this._copyButtonFeedback(P,"Copy Recap","Copy Failed")}}),this._featuredReplayPage.querySelectorAll(".featured-replay-select").forEach(U=>{U.addEventListener("click",()=>{var q,W;const $=U.dataset.id;$&&(this.store.selectStartup($),(W=(q=this.scene)==null?void 0:q.focusOnPod)==null||W.call(q,$))})})}_updateFeaturedSlotPage(e){var w,T,R,S,M;if(!this._isFeaturedSlotPage(e)){this._featuredSlotPage.classList.add("hidden"),this._featuredSlotPage.innerHTML="";return}const t=(w=e.entryContext)==null?void 0:w.slot,n=e.featuredFeed||{},i=(n==null?void 0:n[t])||null,s=this._slotTitle(t),o=this.store.getFeaturedSlotUrl(t),a=((T=e.entryContext)==null?void 0:T.layout)==="social";if(this._featuredSlotPage.classList.remove("hidden"),!i){this._featuredSlotPage.innerHTML=`
      ...
      `;return}const l=`${window.location.origin}${window.location.pathname}?game=${encodeURIComponent(i.game_id)}${i.spectator_token?`&spectator=${encodeURIComponent(i.spectator_token)}`:""}&phase=replay`,c=this._queryUrlFromPayload((R=i.artifacts)==null?void 0:R.card_query)||`${l}&layout=card`,d=this._queryUrlFromPayload((S=i.artifacts)==null?void 0:S.social_query)||`${l}&layout=social`,h=this._buildReplayEmbedSnippet(c,`${s} | Founder Arena`),u=i.social_caption||[i.headline||`${i.winner_startup} won the match.`,i.winner_summary||null,i.story_hook?`Story hook: ${i.story_hook}`:null,i.turning_point_headline?`Turning point: ${i.turning_point_headline}`:null,i.practice_takeaway?`Takeaway: ${i.practice_takeaway}`:null].filter(Boolean).join(`
`);this._featuredSlotPage.innerHTML=`
      <div class="spectator-entry-card spectator-entry-card-replay" style="padding:${a?"22px 20px":"18px 20px"};max-width:${a?"760px":"960px"};margin:0 auto;background:
        ...
        <div class="spectator-entry-topline">
          ...
          <span class="spectator-entry-meta">Canonical slot page &middot; ${i.format_label||"Featured Replay"} &middot; ${i.queue||"showmatch"}${(M=i.artifact_focus)!=null&&M.label?` &middot; ${i.artifact_focus.label}`:""}</span>
        </div>
        <div class="spectator-entry-hero" style="align-items:flex-start">
