        ...
        <div class="rank-item rank-item-${A} ${u?"dead":""} ${f?"selected":""}"
          ...
          <div class="rank-info">
            <div class="rank-topline">
              ...
              ${i?`<div class="metric-delta ${T>0?"up":T<0?"down":""}">${this._formatDelta(T)}</div>`:""}
            </div>
