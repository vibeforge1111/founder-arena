...
`)+`
`+p);const x=y+g+o,v=y+p+a,C=Rl(i,i.VERTEX_SHADER,x),E=Rl(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(P){if(r.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),U=i.getShaderInfoLog(C).trim(),W=i.getShaderInfoLog(E).trim();let q=!0,$=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,E);else{const Y=Ll(i,C,"vertex"),G=Ll(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([o]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const i=new Worker(this.workerSourceURL);i._callbacks={},i._taskCosts={},i._taskLoad=0,i.postMessage({type:"init",decoderConfig:this.decoderConfig}),i.onmessage=function(s){const o=s.data;switch(o.type){case"decode":i._callbacks[o.id].resolve(o);break;case"error":i._callbacks[o.id].reject(o);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+o.type+'"')}},this.workerPool.push(i)}else this.workerPool.sort(function(i,s){return i._taskLoad>s._taskLoad?-1:1});const n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log("Task load: ",this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function w_(){let r,e;onmessage=function(o){const a=o.data;switch(a.type){case"init":r=a.decoderConfig,e=new Promise(function(d){r.onModuleLoaded=function(h){d({draco:h})},DracoDecoderModule(r)});break;case"decode":const l=a.buffer,c=a.taskConfig;e.then(d=>{const h=d.draco,u=new h.Decoder;try{const f=t(h,u,new Int8Array(l),c),m=f.attributes.map(_=>_.array.buffer);f.index&&m.push(f.index.array.buffer),self.postMessage({type:"decode",id:a.id,geometry:f},m)}catch(f){console.error(f),self.postMessage({type:"error",id:a.id,error:f.message})}finally{h.destroy(u)}});break}};function t(o,a,l,c){const d=c.attributeIDs,h=c.attributeTypes;let u,f;const m=a.GetEncodedGeometryType(l);if(m===o.TRIANGULAR_MESH)u=new o.Mesh,f=a.DecodeArrayToMesh(l,l.byteLength,u);else if(m===o.POINT_CLOUD)u=new o.PointCloud,f=a.DecodeArrayToPointCloud(l,l.byteLength,u);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!f.ok()||u.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+f.error_msg());const _={index:null,attributes:[]};for(const g in d){const p=self[h[g]];let y,x;if(c.useUniqueIDs)x=d[g],y=a.GetAttributeByUniqueId(u,x);else{if(x=a.GetAttributeId(u,o[d[g]]),x===-1)continue;y=a.GetAttribute(u,x)}const v=i(o,a,u,g,p,y);g==="color"&&(v.vertexColorSpace=c.vertexColorSpace),_.attributes.push(v)}return m===o.TRIANGULAR_MESH&&(_.index=n(o,a,u)),o.destroy(u),_}function n(o,a,l){const d=l.num_faces()*3,h=d*4,u=o._malloc(h);a.GetTrianglesUInt32Array(l,h,u);const f=new Uint32Array(o.HEAPF32.buffer,u,d).slice();return o._free(u),{array:f,itemSize:1}}function i(o,a,l,c,d,h){const u=h.num_components(),m=l.num_points()*u,_=m*d.BYTES_PER_ELEMENT,g=s(o,d),p=o._malloc(_);a.GetAttributeDataArrayForAllPoints(l,h,g,_,p);const y=new d(o.HEAPF32.buffer,p,m).slice();return o._free(p),{name:c,array:y,itemSize:u}}function s(o,a){switch(a){case Float32Array:return o.DT_FLOAT32;case Int8Array:return o.DT_INT8;case Int16Array:return o.DT_INT16;case Int32Array:return o.DT_INT32;case Uint8Array:return o.DT_UINT8;case Uint16Array:return o.DT_UINT16;case Uint32Array:return o.DT_UINT32}}}class E_{constructor(){this._gltfLoader=new G0,this._textureLoader=new xd,this._modelCache=new Map,this._textureCache=new Map,this._loadingManager=new vd,this._pendingLoads=new Map;const e=new S_;e.setDecoderPath("https://www.gstatic.com/draco/versioned/decoders/1.5.7/"),e.setDecoderConfig({type:"js"}),this._gltfLoader.setDRACOLoader(e),this._gltfLoader.manager=this._loadingManager,this._textureLoader.manager=this._loadingManager,this.ready=!1,this._preloadPromise=null}async loadModel(e){if(this._modelCache.has(e))return this._cloneModel(this._modelCache.get(e));if(this._pendingLoads.has(e))return await this._pendingLoads.get(e),this._cloneModel(this._modelCache.get(e));const t=new Promise((n,i)=>{this._gltfLoader.load(e,s=>{this._modelCache.set(e,s.scene),n(s.scene)},void 0,s=>{console.error(`[AssetLoader] Failed to load model: ${e}`,s),i(s)})});this._pendingLoads.set(e,t);try{await t}finally{this._pendingLoads.delete(e)}return this._cloneModel(this._modelCache.get(e))}async loadTexture(e){return this._textureCache.has(e)?this._textureCache.get(e):new Promise((t,n)=>{this._textureLoader.load(e,i=>{this._textureCache.set(e,i),t(i)},void 0,i=>{console.error(`[AssetLoader] Failed to load texture: ${e}`,i),n(i)})})}async preload(e){const n=(await Promise.allSettled(e.map(i=>this.loadModel(i)))).filter(i=>i.status==="rejected");n.length>0&&console.warn(`[AssetLoader] ${n.length}/${e.length} models failed to preload`),this.ready=!0}_cloneModel(e){const t=e.clone(!0);return t.traverse(n=>{n.isMesh&&(n.material=n.material.clone(),n.castShadow=!0,n.receiveShadow=!0)}),t}dispose(){for(const[,e]of this._modelCache)e.traverse(t=>{t.isMesh&&(t.geometry.dispose(),t.material.map&&t.material.map.dispose(),t.material.dispose())});this._modelCache.clear();for(const[,e]of this._textureCache)e.dispose();this._textureCache.clear()}}const T_=new E_;class A_{constructor(){this.group=new Lt,this._buildFloor(),this._buildGrid(),this._buildCarpetZone(),this._buildAmbientProps(),this._buildCeilingStructure(),this._buildNeonAccents(),this._loadGLBProps()}_buildFloor(){const e=new Mt(80,80,1,1),t=new ne({color:1973802,roughness:.35,metalness:.3}),n=new H(e,t);n.rotation.x=-Math.PI/2,n.receiveShadow=!0,this.group.add(n);const i=new Mt(80,80,1,1),s=new ne({color:2763322,roughness:.15,metalness:.6,transparent:!0,opacity:.12}),o=new H(i,s);o.rotation.x=-Math.PI/2,o.position.y=.005,this.group.add(o)}_buildGrid(){const e=new E0(60,40,2763332,1710638);e.position.y=.01,e.material.opacity=.15,e.material.transparent=!0,this.group.add(e);const t=new qi(14,14.12,64),n=new ne({color:3364266,emissive:new Q(2245802),emissiveIntensity:.3,transparent:!0,opacity:.35,side:It}),i=new H(t,n);i.rotation.x=-Math.PI/2,i.position.y=.02,this.group.add(i)}_buildCarpetZone(){const e=new Mt(28,28,1,1),t=new ne({color:2236984,roughness:.92,metalness:0}),n=new H(e,t);n.rotation.x=-Math.PI/2,n.position.y=.008,n.receiveShadow=!0,this.group.add(n);const i=new ne({color:4482730,emissive:new Q(2245802),emissiveIntensity:.4,transparent:!0,opacity:.5}),s=14,o=.08,a=[{x:0,z:-s,sx:s*2,sz:o},{x:0,z:s,sx:s*2,sz:o},{x:-s,z:0,sx:o,sz:s*2},{x:s,z:0,sx:o,sz:s*2}];for(const l of a){const c=new Mt(l.sx,l.sz),d=new H(c,i);d.rotation.x=-Math.PI/2,d.position.set(l.x,.015,l.z),this.group.add(d)}}_buildAmbientProps(){const e=new ne({color:5592422,roughness:.2,metalness:.8}),t=12,n=new pt(.18,.22,t,12),i=[[-13,0,-13],[13,0,-13],[-13,0,13],[13,0,13]];for(const[g,,p]of i){const y=new H(n,e);y.position.set(g,t/2,p),y.castShadow=!0,this.group.add(y);const x=new Te(.04,t-.5,.04),v=new ne({color:3368703,emissive:new Q(2250222),emissiveIntensity:.8}),C=new H(x,v);C.position.set(g,t/2,p+.2),this.group.add(C);const E=new bt(4482764,.4,14);E.position.set(g,t+.2,p),this.group.add(E)}const s=new ne({color:2762016,roughness:.8}),o=new ne({color:2976570,roughness:.6,emissive:new Q(662026),emissiveIntensity:.2}),a=[[-16,0,-16],[16,0,16],[-16,0,10],[10,0,-16],[0,0,-18],[-18,0,0]];for(const[g,,p]of a){const y=new pt(.28,.2,.5,8),x=new H(y,s);x.position.set(g,.25,p),x.castShadow=!0,this.group.add(x);const v=new Oi(.28,.025,6,12),C=new H(v,s);C.position.set(g,.5,p),C.rotation.x=Math.PI/2,this.group.add(C);const E=4+Math.floor(Math.random()*3);for(let T=0;T<E;T++){const R=.15+Math.random()*.2,S=new Qe(R,8,6),M=new H(S,o);M.position.set(g+(Math.random()-.5)*.3,.55+Math.random()*.45,p+(Math.random()-.5)*.3),M.scale.set(1,.8+Math.random()*.4,1),M.castShadow=!0,this.group.add(M)}}const l=new ne({color:12303308,roughness:.2,metalness:.5}),c=new H(new pt(.2,.2,.8,10),l);c.position.set(18,.9,-5),c.castShadow=!0,this.group.add(c);const d=new ne({color:8965358,roughness:.05,metalness:.1,transparent:!0,opacity:.5}),h=new H(new pt(.18,.2,.4,10),d);h.position.set(18,1.5,-5),this.group.add(h);const u=new ne({color:3355460,roughness:.4,metalness:.4}),f=new H(new Te(3.2,2.2,.1),u);f.position.set(-18,2.2,0),f.rotation.y=Math.PI/2,f.castShadow=!0,this.group.add(f);const m=new H(new Mt(2.9,1.9),new ne({color:15790328,roughness:.95,metalness:0,emissive:new Q(15790328),emissiveIntensity:.05}));m.position.set(-17.94,2.2,0),m.rotation.y=Math.PI/2,this.group.add(m);const _=[16768324,16737928,4513279,8978278];for(let g=0;g<6;g++){const p=new Mt(.3,.25),y=new ne({color:_[Math.floor(Math.random()*_.length)],roughness:.9,side:It}),x=new H(p,y);x.position.set(-17.92,2+(Math.random()-.5)*1.2,(Math.random()-.5)*2),x.rotation.y=Math.PI/2,x.rotation.z=(Math.random()-.5)*.2,this.group.add(x)}this._buildStandingDesk(16,0,5),this._buildStandingDesk(-16,0,-8),this._buildBeanBag(15,0,-12,16737860),this._buildBeanBag(-15,0,12,4491519)}_buildStandingDesk(e,t,n){const i=new ne({color:4473936,metalness:.6,roughness:.25}),s=new ne({color:6967858,roughness:.4,metalness:.05}),o=new H(new Te(1.8,.06,.8),s);o.position.set(e,1.1,n),o.castShadow=!0,this.group.add(o);const a=new pt(.03,.03,1.1,6);for(const[h,u]of[[-.8,-.35],[.8,-.35],[-.8,.35],[.8,.35]]){const f=new H(a,i);f.position.set(e+h,.55,n+u),this.group.add(f)}const l=new H(new Te(.8,.5,.03),new ne({color:2236976,roughness:.3,metalness:.5}));l.position.set(e,1.55,n-.2),this.group.add(l);const c=new H(new Mt(.72,.42),new ne({color:660773,emissive:new Q(1122884),emissiveIntensity:.6,roughness:.1}));c.position.set(e,1.55,n-.183),this.group.add(c);const d=new H(new pt(.02,.02,.3,6),new ne({color:4473936,metalness:.7,roughness:.2}));d.position.set(e,1.28,n-.2),this.group.add(d)}_buildBeanBag(e,t,n,i){const s=new ne({color:i,roughness:.85,metalness:0}),o=new Qe(.45,12,10),a=new H(o,s);a.position.set(e,.3,n),a.scale.set(1,.6,1.1),a.castShadow=!0,this.group.add(a);const l=new Qe(.3,10,8),c=new H(l,s);c.position.set(e,.45,n+.25),c.scale.set(.9,.8,.6),this.group.add(c)}_buildCeilingStructure(){const t=new ne({color:2763317,roughness:.5,metalness:.4}),n=new Te(34,.2,.35);for(const l of[-10,0,10]){const c=new H(n,t);c.position.set(0,12,l),this.group.add(c)}const i=new Te(.35,.2,34);for(const l of[-10,0,10]){const c=new H(i,t);c.position.set(l,12,0),this.group.add(c)}const s=5,o=12-s,a=[[-7,0,-7],[7,0,-7],[-7,0,7],[7,0,7],[0,0,0]];for(const[l,,c]of a){const d=new H(new pt(.005,.005,s,4),t);d.position.set(l,12-s/2,c),this.group.add(d);const h=new ne({color:2236976,roughness:.3,metalness:.5,side:It}),u=new H(new pt(.05,.45,.3,12,1,!0),h);u.position.set(l,o-.15,c),this.group.add(u);const f=new H(new Qe(.07,8,6),new ne({color:16772812,emissive:new Q(16768426),emissiveIntensity:1.5}));f.position.set(l,o-.05,c),this.group.add(f);const m=new bt(16772829,.5,16);m.position.set(l,o,c),this.group.add(m)}}_buildNeonAccents(){const e=new ne({color:3368703,emissive:new Q(2250239),emissiveIntensity:1.2,transparent:!0,opacity:.8}),t=3,n=14,i=[{x:-n,z:-n,dx:t,dz:0},{x:-n,z:-n,dx:0,dz:t},{x:n,z:-n,dx:-t,dz:0},{x:n,z:-n,dx:0,dz:t},{x:-n,z:n,dx:t,dz:0},{x:-n,z:n,dx:0,dz:-t},{x:n,z:n,dx:-t,dz:0},{x:n,z:n,dx:0,dz:-t}];for(const h of i){const u=Math.abs(h.dx||h.dz),f=h.dx!==0,m=new Te(f?u:.04,.03,f?.04:u),_=new H(m,e);_.position.set(h.x+h.dx/2,.02,h.z+h.dz/2),this.group.add(_)}const s=new qi(1,1.1,32),o=new ne({color:4491519,emissive:new Q(3368703),emissiveIntensity:.8,transparent:!0,opacity:.6,side:It}),a=new H(s,o);a.rotation.x=-Math.PI/2,a.position.set(0,.02,-8),this.group.add(a);const l=new Ts(1,32),c=new ne({color:1118498,emissive:new Q(1122884),emissiveIntensity:.3,transparent:!0,opacity:.4}),d=new H(l,c);d.rotation.x=-Math.PI/2,d.position.set(0,.018,-8),this.group.add(d)}async _loadGLBProps(){const e=[{model:"models/bookcaseOpen.glb",pos:[-17,0,-6],rot:Math.PI/2,scale:2},{model:"models/bookcaseOpen.glb",pos:[-17,0,6],rot:Math.PI/2,scale:2},{model:"models/tableCoffeeGlass.glb",pos:[17,0,0],rot:0,scale:2},{model:"models/loungeDesignChair.glb",pos:[17,0,-2],rot:Math.PI,scale:2},{model:"models/loungeDesignChair.glb",pos:[17,0,2],rot:0,scale:2},{model:"models/pottedPlant.glb",pos:[14,0,-14],rot:0,scale:2.5},{model:"models/pottedPlant.glb",pos:[-14,0,14],rot:1.2,scale:2.5},{model:"models/plantSmall1.glb",pos:[18,0,8],rot:.5,scale:2},{model:"models/plantSmall1.glb",pos:[-18,0,-12],rot:2.1,scale:2},{model:"models/lampRoundTable.glb",pos:[16.5,1.12,5.2],rot:0,scale:1.5},{model:"models/lampRoundTable.glb",pos:[-15.5,1.12,-7.8],rot:0,scale:1.5},{model:"models/books.glb",pos:[-17,2.2,-6],rot:.3,scale:1.8},{model:"models/books.glb",pos:[-17,1.2,6],rot:-.4,scale:1.8},{model:"models/rugRound.glb",pos:[17,.01,0],rot:0,scale:3},{model:"models/coffeeMachine.glb",pos:[18,.5,-3],rot:Math.PI,scale:2}];for(const t of e)this._placeModel(t.model,t.pos,t.rot,t.scale)}async _placeModel(e,[t,n,i],s,o){try{const a=await T_.loadModel(e);a.position.set(t,n,i),a.rotation.y=s,a.scale.setScalar(o),a.traverse(l=>{l.isMesh&&(l.castShadow=!0,l.receiveShadow=!0)}),this.group.add(a)}catch{}}}function hn(r){if(r==null)return"$0";const e=Number(r);return e>=1e6?`$${(e/1e6).toFixed(1)}M`:e>=1e3?`$${(e/1e3).toFixed(0)}K`:`$${e.toFixed(0)}`}function C_(r){if(r==null)return"0";const e=Number(r);return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:e.toFixed(0)}function gt(r){return r==null?"0.0":Number(r).toFixed(1)}function R_(r){if(r==null)return"?";const e=Number(r);return e>24?"24+mo":`${e.toFixed(1)}mo`}const P_=5915182,L_=1973806,I_=396826,yc=[16109737,15251594,13931883,13010498,9262372,1578e4],bc=[1710618,3809296,7029286,9136404,12883018,2759178,4860442,9116186,1714746],Mc=["tshirt","hoodie","blazer","polo"],Sc=["short","medium","buzz","pompadour","bun","sidePart"];class D_{constructor(e,t){this.startupId=e,this.accentHex=t,this.accent=new Q(t),this.group=new Lt,this.clickTargets=[],this._highlighted=!1,this._alive=!0,this._bobOffset=Math.random()*Math.PI*2,this._seed=this._hashCode(e),this._rng=this._makeRng(this._seed),this._skinTone=yc[this._rngInt(yc.length)],this._hairColor=bc[this._rngInt(bc.length)],this._hairStyle=Sc[this._rngInt(Sc.length)],this._shirtStyle=Mc[this._rngInt(Mc.length)],this._hasGlasses=this._rng()>.65,this._hasHeadphones=!this._hasGlasses&&this._rng()>.75,this._hasBeard=this._rng()>.7,this._bodyScale=.9+this._rng()*.2,this._buildDeskSetup(),this._buildChair(),this._buildCharacter(),this._buildLaptop(),this._buildDeskProps(),this._buildAccentLight(),this._buildFloorMat(),this._buildLabel(),this._buildMetricBars()}_buildDeskSetup(){const e=new Te(2.6,.1,1.3),t=new ne({color:P_,roughness:.35,metalness:.08});this.deskTop=new H(e,t),this.deskTop.position.set(0,.75,0),this.deskTop.castShadow=!0,this.deskTop.receiveShadow=!0,this.deskTop.userData.startupId=this.startupId,this.clickTargets.push(this.deskTop),this.group.add(this.deskTop);const n=new ne({color:4473936,metalness:.7,roughness:.25}),i=new Te(.06,.7,1.2),s=new H(i,n);s.position.set(-1.2,.35,0),s.castShadow=!0,this.group.add(s);const o=new H(i,n);o.position.set(1.2,.35,0),o.castShadow=!0,this.group.add(o);const a=new Te(2.34,.04,.04),l=new H(a,n);l.position.set(0,.08,0),this.group.add(l)}_buildChair(){const e=new ne({color:L_,roughness:.7,metalness:0}),t=new ne({color:this.accent,roughness:.6,metalness:.1}),n=new Lt;n.position.set(0,0,1.1);const i=new Te(.55,.08,.55),s=new H(i,e);s.position.y=.48,s.castShadow=!0,n.add(s);const o=new Te(.55,.65,.06),a=new H(o,e);a.position.set(0,.83,.26),a.castShadow=!0,n.add(a);const l=new Te(.08,.5,.005),c=new H(l,t);c.position.set(0,.85,.228),n.add(c);const d=new Te(.06,.04,.35),h=new ne({color:2763320,roughness:.4,metalness:.3}),u=new ne({color:3355458,roughness:.8});for(const _ of[-1,1]){const g=new H(d,h);g.position.set(_*.28,.62,.08),n.add(g);const p=new H(new Te(.065,.015,.15),u);p.position.set(_*.28,.645,0),n.add(p)}const f=new ne({color:6710896,metalness:.8,roughness:.15}),m=new H(new pt(.035,.04,.35,8),f);m.position.y=.28,n.add(m);for(let _=0;_<5;_++){const g=_/5*Math.PI*2,p=new Te(.025,.025,.25),y=new H(p,f);y.position.set(Math.cos(g)*.12,.08,Math.sin(g)*.12),y.rotation.y=g,n.add(y);const x=new H(new Qe(.035,8,6),new ne({color:2236968,roughness:.9}));x.position.set(Math.cos(g)*.22,.035,Math.sin(g)*.22),n.add(x)}this.group.add(n)}_buildCharacter(){this.characterGroup=new Lt,this.characterGroup.position.set(0,0,1.1);const e=this._bodyScale;this.characterGroup.scale.setScalar(e);const t=new ne({color:this._skinTone,roughness:.55,metalness:0}),n=new ne({color:this.accent,roughness:.4,metalness:.05});this._clothesMat=n;const i=new ne({color:new Q(this.accent).clone().multiplyScalar(.3).offsetHSL(0,-.2,0),roughness:.6}),s=new Te(.4,.5,.25,2,2,2);if(this._roundifyGeometry(s,.06),this.body=new H(s,n),this.body.position.y=1,this.body.castShadow=!0,this.body.userData.startupId=this.startupId,this.clickTargets.push(this.body),this.characterGroup.add(this.body),this._shirtStyle==="hoodie"){const x=new Qe(.14,8,6,0,Math.PI*2,0,Math.PI*.45),v=new H(x,n);v.position.set(0,1.28,.06),v.rotation.x=.4,this.characterGroup.add(v)}else if(this._shirtStyle==="blazer"){const x=new ne({color:new Q(this.accent).clone().multiplyScalar(.65),roughness:.4});for(const v of[-1,1]){const C=new H(new Te(.05,.16,.01),x);C.position.set(v*.07,1.13,-.13),C.rotation.z=v*.15,this.characterGroup.add(C)}}const o=new H(new pt(.06,.08,.1,8),t);o.position.y=1.29,this.characterGroup.add(o),this.head=new Lt,this.head.position.y=1.55,this.characterGroup.add(this.head);const a=new Qe(.24,20,16),l=new H(a,t);l.scale.set(1,1.12,.95),l.castShadow=!0,this.head.add(l);const c=new Qe(.1,10,8),d=new H(c,t);d.position.set(0,-.18,-.08),d.scale.set(1.2,.6,.7),this.head.add(d);for(const x of[-1,1]){const v=new H(new Qe(.04,8,6),t);v.position.set(x*.235,-.02,.02),v.scale.set(.5,.8,.7),this.head.add(v)}const h=new ne({color:16777215,roughness:.1,metalness:0}),u=[3832394,3824267,8018474,2783866,5913210],f=u[this._rngInt(u.length)];for(const x of[-1,1]){const v=new H(new Qe(.065,14,12),h);v.position.set(x*.09,.02,-.2),v.scale.set(.85,.9,.4),this.head.add(v);const C=new ne({color:f,roughness:.15}),E=new H(new Qe(.042,12,10),C);E.position.set(x*.09,.01,-.225),E.scale.set(.8,.85,.35),this.head.add(E);const T=new ne({color:328976,roughness:.05}),R=new H(new Qe(.022,10,8),T);R.position.set(x*.09,.008,-.235),R.scale.set(.7,.8,.3),this.head.add(R),x===-1?this._leftPupil=R:this._rightPupil=R;const S=new on({color:16777215}),M=new H(new Qe(.01,6,5),S);M.position.set(x*.075,.035,-.238),this.head.add(M);const P=new H(new Qe(.006,5,4),S);P.position.set(x*.1,.005,-.238),this.head.add(P);const O=new ne({color:new Q(this._skinTone).clone().multiplyScalar(.88),roughness:.5}),U=new H(new Te(.075,.012,.025),O);U.position.set(x*.09,.065,-.215),this.head.add(U)}const m=new ne({color:this._hairColor,roughness:.7});for(const x of[-1,1]){const v=new Te(.07,.02,.025,1,1,1);this._roundifyGeometry(v,.005);const C=new H(v,m);C.position.set(x*.09,.09,-.2),C.rotation.z=x*.12,this.head.add(C)}const _=new H(new Qe(.025,8,6),t);_.position.set(0,-.04,-.23),_.scale.set(.8,.65,.6),this.head.add(_);const g=new ne({color:new Q(this._skinTone).clone().multiplyScalar(.5),roughness:.5}),p=new H(new Te(.06,.008,.01),g);p.position.set(0,-.1,-.22),this.head.add(p);for(const x of[-1,1]){const v=new H(new Qe(.005,4,3),g);v.position.set(x*.032,-.096,-.22),this.head.add(v)}if(this._buildHairStyled(),this._hasGlasses){const x=new ne({color:2236979,roughness:.2,metalness:.6}),v=new ne({color:11193582,roughness:.05,metalness:.2,transparent:!0,opacity:.25});for(const E of[-1,1]){const T=new H(new Oi(.05,.006,6,16),x);T.position.set(E*.085,.01,-.24),this.head.add(T);const R=new H(new Ts(.044,12),v);R.position.set(E*.085,.01,-.242),this.head.add(R)}const C=new H(new Te(.05,.006,.006),x);C.position.set(0,.015,-.24),this.head.add(C);for(const E of[-1,1]){const T=new H(new Te(.005,.006,.12),x);T.position.set(E*.13,.015,-.18),this.head.add(T)}}if(this._hasHeadphones){const x=new ne({color:2763317,roughness:.25,metalness:.6}),v=new H(new Oi(.26,.016,8,16,Math.PI),x);v.position.set(0,.2,0),v.rotation.z=Math.PI,this.head.add(v);for(const C of[-1,1]){const E=new H(new pt(.065,.065,.04,10),x);E.position.set(C*.26,-.01,0),E.rotation.z=Math.PI/2,this.head.add(E);const T=new ne({color:1710626,roughness:.9}),R=new H(new pt(.055,.055,.015,10),T);R.position.set(C*.24,-.01,0),R.rotation.z=Math.PI/2,this.head.add(R)}}if(this._hasBeard){const x=new ne({color:new Q(this._hairColor).clone().multiplyScalar(.85),roughness:.8}),v=new Te(.2,.1,.15,2,2,2);this._roundifyGeometry(v,.03);const C=new H(v,x);C.position.set(0,-.14,-.1),this.head.add(C);const E=new H(new Te(.08,.015,.015),x);E.position.set(0,-.085,-.22),this.head.add(E)}for(const x of[-1,1]){const v=new Te(.1,.42,.1),C=new H(v,t);v.translate(0,-.21,0),C.position.set(x*.26,1.2,-.02),C.rotation.x=.85,C.rotation.z=x*-.1,C.castShadow=!0,this.characterGroup.add(C),x===-1?this.leftArm=C:this.rightArm=C}this.leftUpperArm=null,this.rightUpperArm=null,this._leftHand=null,this._rightHand=null;const y=new Te(.1,.35,.1,1,1,1);this._roundifyGeometry(y,.02);for(const x of[-1,1]){const v=new H(y,i);v.position.set(x*.1,.55,-.02),v.rotation.x=Math.PI/2.1,this.characterGroup.add(v);const C=new H(y,i);C.position.set(x*.1,.37,-.33),C.rotation.x=.08,this.characterGroup.add(C);const E=new ne({color:16777215,roughness:.5,metalness:.05}),T=new H(new Te(.11,.06,.17),E);T.position.set(x*.1,.2,-.36),this.characterGroup.add(T);const R=new ne({color:this.accent,roughness:.7}),S=new H(new Te(.12,.025,.18),R);S.position.set(x*.1,.185,-.36),this.characterGroup.add(S)}this.group.add(this.characterGroup)}_roundifyGeometry(e,t){const n=e.attributes.position,i=new L;for(let s=0;s<n.count;s++){i.fromBufferAttribute(n,s);const o=i.length();o>0&&(i.normalize().multiplyScalar(o+t),n.setXYZ(s,i.x,i.y,i.z))}n.needsUpdate=!0,e.computeVertexNormals()}_buildHairStyled(){const e=new ne({color:this._hairColor,roughness:.65});switch(this._hairStyle){case"short":{const t=new Qe(.25,14,12,0,Math.PI*2,0,Math.PI*.52),n=new H(t,e);n.position.y=1.6,n.scale.set(1,.92,.98),this.characterGroup.add(n);break}case"medium":{const t=new Qe(.265,14,12,0,Math.PI*2,0,Math.PI*.58),n=new H(t,e);n.position.y=1.59,n.scale.set(1.04,.98,1.08),this.characterGroup.add(n);for(const i of[-1,1]){const s=new H(new Qe(.09,8,6),e);s.position.set(i*.2,1.53,.02),s.scale.set(.6,1.1,.9),this.characterGroup.add(s)}break}case"buzz":{const t=new Qe(.248,12,10,0,Math.PI*2,0,Math.PI*.48),n=new H(t,new ne({color:this._hairColor,roughness:.9}));n.position.y=1.6,this.characterGroup.add(n);break}case"pompadour":{const t=new H(new Qe(.255,14,12,0,Math.PI*2,0,Math.PI*.52),e);t.position.y=1.6,this.characterGroup.add(t);const n=new H(new Qe(.12,10,8),e);n.position.set(0,1.73,-.12),n.scale.set(1.3,.7,.9),this.characterGroup.add(n);break}case"bun":{const t=new H(new Qe(.25,12,10,0,Math.PI*2,0,Math.PI*.48),e);t.position.y=1.6,this.characterGroup.add(t);const n=new H(new Qe(.09,10,8),e);n.position.set(0,1.77,.06),this.characterGroup.add(n);break}case"sidePart":{const t=new Qe(.26,14,12,0,Math.PI*2,0,Math.PI*.55),n=new H(t,e);n.position.y=1.59,n.scale.set(1.02,.94,1.03),this.characterGroup.add(n);const i=new H(new Qe(.08,8,6),e);i.position.set(-.15,1.63,-.14),i.scale.set(1.1,.5,.7),this.characterGroup.add(i);break}}}_hashCode(e){let t=0;for(let n=0;n<e.length;n++)t=(t<<5)-t+e.charCodeAt(n),t|=0;return Math.abs(t)}_makeRng(e){let t=e;return()=>(t=t*1664525+1013904223&4294967295,(t>>>0)/4294967295)}_rngInt(e){return Math.floor(this._rng()*e)}_buildLaptop(){const e=new Lt;e.position.set(0,.8,-.1);const t=new ne({color:8947858,roughness:.15,metalness:.7}),n=new Te(.5,.015,.35),i=new H(n,t);i.castShadow=!0,e.add(i);const s=new Lt;s.position.set(0,.008,-.17),s.rotation.x=-.25;const o=new Te(.5,.35,.008),a=new H(o,t);a.position.y=.175,s.add(a);const l=new ne({color:1118485,roughness:.3,metalness:.2}),c=new H(new Te(.48,.33,.003),l);c.position.set(0,.175,.006),s.add(c),this.screenFace=new H(new Mt(.44,.29),new ne({color:I_,emissive:new Q(1717094),emissiveIntensity:1.2,roughness:.05})),this.screenFace.position.set(0,.175,.0085),s.add(this.screenFace);const d=new bt(3359880,.3,2);d.position.set(0,.1,-.1),s.add(d),e.add(s);const h=new H(new Mt(.4,.25),new ne({color:657938,emissive:new Q(1118498),emissiveIntensity:.5,roughness:.15}));h.rotation.x=-Math.PI/2,h.position.set(0,.009,.02),e.add(h);const u=new H(new Mt(.14,.1),new ne({color:7829376,roughness:.1,metalness:.6}));u.rotation.x=-Math.PI/2,u.position.set(0,.009,.12),e.add(u),this.group.add(e)}_buildDeskProps(){const e=new ne({color:2236976,roughness:.25,metalness:.5}),t=new H(new Te(.9,.55,.025),e);t.position.set(0,1.2,-.55),t.castShadow=!0,this.group.add(t);const n=new H(new Mt(.82,.47),new ne({color:396824,emissive:new Q(926276),emissiveIntensity:.9,roughness:.05}));n.position.set(0,1.2,-.536),this.group.add(n);const i=new H(new pt(.02,.025,.35,8),e);i.position.set(0,.95,-.55),this.group.add(i);const s=new H(new pt(.12,.12,.015,10),new ne({color:3355456,metalness:.7,roughness:.2}));s.position.set(0,.79,-.55),this.group.add(s);const o=new Q(this.accent).clone().lerp(new Q(16777215),.6),a=new ne({color:o,roughness:.45,metalness:.05}),l=new H(new pt(.045,.04,.09,10),a);l.position.set(.9,.85,.2),l.castShadow=!0,this.group.add(l);const c=new H(new Oi(.025,.006,6,10,Math.PI),a);c.position.set(.945,.85,.2),c.rotation.y=Math.PI/2,this.group.add(c);const d=new H(new Ts(.038,10),new ne({color:3809296,roughness:.9}));d.position.set(.9,.9,.2),d.rotation.x=-Math.PI/2,this.group.add(d);const h=new ne({color:1118488,roughness:.15,metalness:.4}),u=new H(new Te(.08,.008,.16),h);u.position.set(-.85,.81,.15),u.rotation.y=.2,u.castShadow=!0,this.group.add(u);const f=new H(new Mt(.065,.13),new ne({color:657941,emissive:new Q(1118501),emissiveIntensity:.4,roughness:.1}));f.position.set(-.85,.815,.15),f.rotation.x=-Math.PI/2,f.rotation.z=.2,this.group.add(f);const m=new ne({color:13404228,roughness:.7}),_=new H(new pt(.04,.035,.05,6),m);_.position.set(1.05,.83,-.3),this.group.add(_);const g=new ne({color:4500053,roughness:.7});for(let R=0;R<4;R++){const S=new H(new Qe(.025,6,5),g);S.position.set(1.05+(Math.random()-.5)*.03,.87+Math.random()*.02,-.3+(Math.random()-.5)*.03),S.scale.set(1,.6,1),this.group.add(S)}const p=new ne({color:this.accent,roughness:.3,metalness:.6}),y=new H(new pt(.025,.025,.1,8),p);y.position.set(-.7,.85,-.35),y.castShadow=!0,this.group.add(y);const x=new H(new pt(.025,.025,.003,8),new ne({color:11184810,metalness:.8,roughness:.2}));x.position.set(-.7,.9,-.35),this.group.add(x);const v=new ne({color:2763314,roughness:.35,metalness:.3}),C=new H(new Te(.5,.018,.18),v);C.position.set(0,.815,.45),C.castShadow=!0,this.group.add(C);const E=new ne({color:3816004,roughness:.5,metalness:.2});for(let R=0;R<3;R++){const S=new H(new Te(.44,.006,.04),E);S.position.set(0,.827,.38+R*.055),this.group.add(S)}const T=new H(new Te(.2,.006,.03),E);T.position.set(0,.827,.55),this.group.add(T)}_buildAccentLight(){this.accentLight=new bt(this.accent,.8,6),this.accentLight.position.set(0,2.2,.5),this.group.add(this.accentLight);const e=new bt(this.accent,.15,3);e.position.set(0,.1,.5),this.group.add(e)}_buildFloorMat(){const e=new Mt(3.2,2.8),t=new ne({color:new Q(this.accent).multiplyScalar(.1),roughness:.95,metalness:0,transparent:!0,opacity:.3}),n=new H(e,t);n.rotation.x=-Math.PI/2,n.position.set(0,.006,.5),n.receiveShadow=!0,this.group.add(n)}_buildLabel(){const e=document.createElement("div");e.style.cssText=`
    ...
    `}update(e){const t=e.gameData;if(!(t==null?void 0:t.startups))return;const i=wr(t),s=Rs(t),o=new Map(((t==null?void 0:t.rankings)||[]).map(d=>[d.startup_id,d]));for(const d of s)this._startupOrderMap.has(d.id)||this._startupOrderMap.set(d.id,this._startupOrderMap.size);const a=e.selectedStartupId,l=this._isSharedReplay(e,t),c=this._replaySpotlights(t,s);this._list.innerHTML=`
      ...
      ${s.map((d,h)=>{const u=this._startupOrderMap.get(d.id)||0,f=La(u),m=d.alive===!1,_=d.id===a,g=d.product_quality||0,p=d.morale||0,y=d.brand||0,x=(d.startup_name||"?")[0].toUpperCase(),v=h===0?"&#128081;":h+1,C=o.get(d.id),E=i?`${gt(Dn(d))} score`:hn(d.valuation),T=i?`${hn(d.valuation)} val`:"",R=i?d.score_delta??(C==null?void 0:C.score_delta)??0:0,S=d.pressure_level||(C==null?void 0:C.pressure_level)||"neutral",M=this._renderRiskTags(d,C),P=[];l&&(d.id===c.winnerId&&P.push({label:"Winner",tone:"positive"}),d.id===c.runnerUpId&&P.push({label:"Runner-up",tone:"neutral"}),c.turningPointIds.has(d.id)&&P.push({label:"Turning Point",tone:"warning"}));const O=P.map(U=>`<span class="signal-pill signal-pill-${U.tone}">${U.label}</span>`).join("");return`
    ...
    `).join(""),q=(i.seven_dimension_scores||{}).dimensions||{},$=Object.keys(q).length>0?Object.entries(q).map(([re,oe])=>{const we=Math.round(Number(oe)||0),Re=re.replace(/_/g," "),Ne=we>=70?"#34D058":we>=40?"#FFB800":"#EF4444";return`
      ...
      <div class="stat-grid">
        ...
        <div class="stat-cell">
          ...
          <div class="stat-value" style="color:${p>0?"#34D058":p<0?"#EF4444":"var(--text-dim)"}">${Math.abs(p)<.05?"Flat":`${p>0?"+":""}${gt(p)}`}</div>
        </div>
        <div class="stat-cell">
      ...
      <div style="margin-bottom:12px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.05);border-radius:12px;padding:10px 12px">
        ${d?`
          <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
            ...
            <div style="font-size:8px;color:#A78BFA;border:1px solid rgba(167,139,250,0.22);background:rgba(167,139,250,0.08);border-radius:999px;padding:3px 8px">${v>0&&(c==null?void 0:c.id)!==t?`${gt(v)} behind leader`:`${gt(R)} gap`}</div>
          </div>
          <div style="font-size:9px;color:var(--text-dim);line-height:1.5;margin-top:8px">
            ${d.id===(c==null?void 0:c.id)&&d.id!==t?`${i.startup_name} needs ${gt(v)} score to catch the leader.`:`${i.startup_name} is being compared against ${d.startup_name}'s current score balance.`}
          </div>
          ${x.strengths.length>0?`<div style="font-size:9px;color:#34D058;margin-top:8px">Ahead on: ${x.strengths.map(re=>`${re.label} (+${gt(re.delta)})`).join(" · ")}</div>`:""}
          ${x.gaps.length>0?`<div style="font-size:9px;color:#EF4444;margin-top:4px">Losing on: ${x.gaps.map(re=>`${re.label} (${gt(re.delta)})`).join(" · ")}</div>`:""}
    ...
    `,this.open(),n){const u=this._exampleAgentCommand({agentName:a,startupName:l,sector:c,motto:d,strategy:h,agentToken:n.agent_token,startupId:n.startup_id});this._showAttachCommand(u),this._modal.querySelectorAll("#da-agent-name, #da-startup-name, #da-sector, #da-motto, #da-strategy").forEach(_=>{_.disabled=!0,_.style.opacity="0.5"});const f=this._modal.querySelector("#da-deploy"),m=this._modal.querySelector("#da-status");f&&(f.disabled=!0,f.style.background="#22C55E"),m&&(m.style.color="#22C55E",m.textContent="Slot reserved. Start your local runner before starting the match.")}this._modal.querySelector("#da-deploy").addEventListener("click",async()=>{const u=this._modal.querySelector("#da-deploy"),f=this._modal.querySelector("#da-status");u.textContent="Reserving...",u.disabled=!0,f.style.color="#888",f.textContent="Reserving startup slot...";try{const m={agentName:this._modal.querySelector("#da-agent-name").value.trim()||"MyFounder",startupName:this._modal.querySelector("#da-startup-name").value.trim()||"NeuralForge",sector:this._modal.querySelector("#da-sector").value,motto:this._modal.querySelector("#da-motto").value.trim(),strategyDescription:this._modal.querySelector("#da-strategy").value},_=await this.store.joinAsPlayer(m),g=this._exampleAgentCommand({...m,strategy:this._modal.querySelector("#da-strategy").value,agentToken:_.agent_token,startupId:_.startup_id});f.style.color="#22C55E",f.textContent="Slot reserved. Run the terminal command, then start the match.",u.textContent="Slot Reserved",u.style.background="#22C55E",this._showAttachCommand(g);const p=this._modal.querySelector("#da-runner-wrap"),y=this._modal.querySelector("#da-runner-presence");p&&(p.style.display="block"),y&&(y.innerHTML=this._renderRunnerPresence(this._fallbackRunnerPresence())),this._modal.querySelectorAll("#da-agent-name, #da-startup-name, #da-sector, #da-motto, #da-strategy").forEach(x=>{x.disabled=!0,x.style.opacity="0.5"})}catch(m){f.style.color="#EF4444",f.textContent=`Error: ${m.message}`,u.textContent="Retry Deploy",u.disabled=!1}}),this._modal.querySelector("#lobby-cancel").addEventListener("click",()=>this.close()),this._modal.querySelector("#lobby-fill").addEventListener("click",async()=>{const u=this._modal.querySelector("#lobby-fill");u.textContent="Starting...",u.disabled=!0;try{await this.store.fillBotsAndStart(s),setTimeout(()=>this.close(),1e3)}catch{u.textContent="Error - Retry",u.disabled=!1}}),this._lobbyUpdateInterval=setInterval(()=>{var v,C;const u=this.store.state;if(u.view!=="lobby"){clearInterval(this._lobbyUpdateInterval),this._lobbyUpdateInterval=null;return}const f=((v=u.gameData)==null?void 0:v.startups)||{},m=this._modal.querySelector("#lobby-agents"),_=this._modal.querySelector("#da-runner-presence"),g=this._modal.querySelector("#da-runner-failure");if(!m)return;const p=Object.values(f),y=(C=this._modal.querySelector("#da-startup-name"))==null?void 0:C.value,x=p.find(E=>E.id===this.store.state.myStartupId||E.startup_name===y);if(_&&(_.innerHTML=this._renderRunnerPresence((x==null?void 0:x.runner_presence)||this._fallbackRunnerPresence())),g&&(g.innerHTML=this._renderRunnerFailure((x==null?void 0:x.runner_failure)||null)),p.length===0){m.innerHTML='<div style="font-size:10px;color:var(--text-muted);padding:10px;text-align:center">Waiting for agents...</div>';return}m.innerHTML=p.map(E=>{const T=E.id===this.store.state.myStartupId||E.startup_name===y,R=E.runner_presence||this._fallbackRunnerPresence(),S=E.runner_failure||null;return`
...
`)}_formatShowmatchLabel(e,t="Showmatch"){const n=String(e||"").trim();return n?n.replace(/[_-]+/g," ").replace(/\s+/g," ").replace(/\b\w/g,i=>i.toUpperCase()):t}_extractModelLabel(e){var i;const t=`${(e==null?void 0:e.agent_name)||""} ${(e==null?void 0:e.startup_name)||""}`.toLowerCase();return((i=[{token:"gpt",label:"GPT"},{token:"claude",label:"Claude"},{token:"gemini",label:"Gemini"},{token:"llama",label:"Llama"},{token:"mistral",label:"Mistral"},{token:"qwen",label:"Qwen"},{token:"deepseek",label:"DeepSeek"},{token:"grok",label:"Grok"}].find(s=>t.includes(s.token)))==null?void 0:i.label)||null}_buildFeaturedReplay(e,t,n,i){var C,E,T;const s=t[0]||null,o=t[1]||null,a=((e==null?void 0:e.turning_points)||[])[0]||null,l=((e==null?void 0:e.runner_incidents)||[])[0]||null,c=t.slice(1,3).map(R=>{var S;return(S=e==null?void 0:e.startup_outcomes)!=null&&S[R.id]?{startup:R,outcome:e.startup_outcomes[R.id]}:null}).find(Boolean),d=[s,o].map(R=>this._extractModelLabel(R)),h=s!=null&&s.strategy?this._formatShowmatchLabel(s.strategy):null,u=o!=null&&o.strategy?this._formatShowmatchLabel(o.strategy):null,f=Number(e==null?void 0:e.final_margin),m=Number.isFinite(f)&&f<=2.5,_=!!((e==null?void 0:e.turning_points)||[]).some(R=>R==null?void 0:R.leader_changed),g=(e==null?void 0:e.practice_takeaway)||null;let p=i?"Featured Duel":"Featured Replay",y=o?`${(s==null?void 0:s.startup_name)||"Unknown"} vs ${o.startup_name||"Unknown"}`:`${(s==null?void 0:s.startup_name)||(n==null?void 0:n.name)||"Founder Arena"}`,x=o?`${(s==null?void 0:s.agent_name)||"Unknown"} vs ${o.agent_name||"Unknown"}`:`${(s==null?void 0:s.agent_name)||(s==null?void 0:s.startup_name)||"Unknown"} spotlight`;i&&s&&o&&d[0]&&d[1]&&d[0]!==d[1]?(p="Model vs Model",y=`${d[0]} vs ${d[1]}`,x=`${s.startup_name} vs ${o.startup_name}`):i&&s&&o&&h&&u&&h!==u?(p="Doctrine vs Doctrine",y=`${h} vs ${u}`,x=`${s.startup_name} vs ${o.startup_name}`):n!=null&&n.benchmark_tier&&n.benchmark_tier!=="baseline"||g?(p="Benchmark Gauntlet",y=`${(s==null?void 0:s.startup_name)||"Unknown"} vs ${this._formatShowmatchLabel(n==null?void 0:n.benchmark_tier,"Benchmark")}`,x=(g==null?void 0:g.headline)||`${(n==null?void 0:n.queue)||"showmatch"} replay`):i&&(m||_)?(p="Underdog Challenge",y=o?`${(s==null?void 0:s.startup_name)||"Unknown"} vs ${o.startup_name||"Unknown"}`:y,x=m?`Finished within ${f.toFixed(1)} score`:"Lead changed during the replay"):t.length>2&&(p="Benchmark Gauntlet",y=`${(s==null?void 0:s.startup_name)||"Unknown"} vs ${Math.max(t.length-1,1)} challengers`,x=`${(n==null?void 0:n.queue)||"showmatch"} field`);const v=(a==null?void 0:a.headline)||((E=(C=c==null?void 0:c.outcome)==null?void 0:C.runner_failure)==null?void 0:E.headline)||((T=c==null?void 0:c.outcome)==null?void 0:T.headline)||(e==null?void 0:e.winner_summary)||`${(s==null?void 0:s.startup_name)||"Unknown"} won the match.`;return{formatLabel:p,matchupLabel:y,deckLabel:x,storyHook:v,topTurningPoint:a,topRunnerIssue:l,topLoser:c}}_buildSharePackage(e,t,n,i){var m,_,g;const s=n[0],o=n[1],a=this._buildFeaturedReplay(t,n,e,i),l=a.topTurningPoint,c=a.topRunnerIssue,d=a.topLoser,h=this.store.getShareUrl(),u=i?`${(s==null?void 0:s.startup_name)||"Unknown"} beat ${(o==null?void 0:o.startup_name)||"the field"} by ${(t==null?void 0:t.final_margin)!=null?`${gt(t.final_margin)} score`:"a narrow margin"}`:`${(s==null?void 0:s.startup_name)||"Unknown"} won Founder Arena`,f=[`${a.formatLabel}: ${a.matchupLabel}`,(t==null?void 0:t.winner_summary)||u,l!=null&&l.headline?`Turning point: ${l.headline}`:null,c!=null&&c.headline?`Runner issue: ${c.headline}`:null,d!=null&&d.outcome?`Why they lost: ${((m=d.outcome.runner_failure)==null?void 0:m.headline)||d.outcome.headline}`:null,(_=t==null?void 0:t.practice_takeaway)!=null&&_.headline?`Practice takeaway: ${t.practice_takeaway.headline}`:null,h||null].filter(Boolean);return{...a,headline:u,caption:f.join(`
`),featuredCard:[`${a.formatLabel} | ${a.matchupLabel}`,a.deckLabel?`Deck: ${a.deckLabel}`:null,`Headline: ${u}`,`Winner Summary: ${(t==null?void 0:t.winner_summary)||`${(s==null?void 0:s.startup_name)||"Unknown"} won the match.`}`,l!=null&&l.headline?`Turning Point: ${l.headline}`:null,c!=null&&c.headline?`Runner Issue: ${c.headline}`:null,d!=null&&d.outcome?`Why They Lost: ${((g=d.outcome.runner_failure)==null?void 0:g.headline)||d.outcome.headline}`:null,h?`Replay: ${h}`:null,"","Caption:",f.join(`
`)].filter(p=>p!=null).join(`
`)}}showPostGame(e={}){var m;const t=this.store.state.gameData;if(!t)return;const n=wr(t),i=Rs(t),s=t.summary||{},o=this.store.getShareUrl(),a=this._buildSharePackage(t,s,i,n),c=(e.entryMode||null)==="sharedReplay",d=i[0],h=i.slice(0,3),u=n?`${gt(Dn(d))} score`:uo(d==null?void 0:d.valuation),f=n?`${uo(d==null?void 0:d.valuation)} valuation`:`${(d==null?void 0:d.sector)||""}`;this._modal.innerHTML=`
      ...
      <div style="margin:16px 0">
        ${h.map((_,g)=>{const p=["#FFB800","#94A3B8","#CD7F32"];return`
            <div style="display:flex;align-items:center;gap:12px;padding:10px 14px;margin-bottom:4px;
              ...
              <div style="font-size:14px;font-weight:900;color:${p[g]};text-shadow:0 0 8px ${p[g]}33">${n?`${gt(Dn(_))} score`:uo(_.valuation)}</div>
            </div>
          `}).join("")}
      </div>
...
`)}_buildReplayEmbedSnippet(e,t="Founder Arena Featured Replay"){return e?`<iframe src="${e}" title="${t}" width="720" height="900" style="width:100%;max-width:720px;height:900px;border:0;border-radius:16px;overflow:hidden;" loading="lazy"></iframe>`:""}_syncReplayLayoutChrome(e){var d;const t=this._isFeaturedReplayPage(e),n=this._isReplayCardLayout(e),i=this._isReplaySocialLayout(e)||((d=e.entryContext)==null?void 0:d.layout)==="social",s=this._isFeaturedSlotPage(e),o=t||s;this.rankings.el.style.display=o?"none":"",this.timeline._wrapper.style.display=o?"none":"",this.detail.el.style.display=o?"none":"";const a=this._header.querySelector("#btn-quick-play"),l=this._header.querySelector("#btn-new-game"),c=this._header.querySelector("#btn-watch");[a,l,c].forEach(h=>{h&&(h.style.display=n||i?"none":"")})}_updateDiscoveryShelf(e){if(!!(e.gameId||e.gameData)||this._isFeaturedSlotPage(e)){this._discoveryShelf.classList.add("hidden"),this._discoveryShelf.innerHTML="";return}const n=Array.isArray(e.games)?e.games:[],i=e.leaderboardData||{},s=e.featuredFeed||{},o=(s.live_now||[]).length>0?s.live_now:n.filter(m=>m.phase==="playing").sort((m,_)=>(_.turn||0)-(m.turn||0)).slice(0,3),a=(s.featured_replays||[]).length>0?(s.featured_replays||[]).slice(0,4):[];if(a.length===0){for(const m of i.leaderboard||[])if(!(m.game_mode!=="competitive_mode"||!m.was_winner)&&!a.some(_=>_.game_id===m.game_id)&&(a.push(m),a.length>=4))break}const l=(i.agent_rankings||[]).slice(0,5),c=[{label:"Daily Featured Duel",accent:"#FFB800",item:s.daily_featured_duel,mode:"slot",slot:"daily_featured_duel"},{label:"Weekly Upset Recap",accent:"#A78BFA",item:s.weekly_upset_recap,mode:"slot",slot:"weekly_upset_recap"},{label:"Beat This Benchmark",accent:"#22D3EE",item:s.benchmark_challenge,mode:"slot",slot:"benchmark_challenge"}];if(o.length===0&&a.length===0&&l.length===0&&!c.some(m=>m.item)){this._discoveryShelf.classList.add("hidden"),this._discoveryShelf.innerHTML="";return}const d=o.length>0?o.map(m=>`
        ...
        `).join(""):'<div style="font-size:10px;color:var(--text-muted)">Leaderboard is still warming up.</div>',f=c.map(m=>{var y;if(!m.item)return`
        ...
        `;const _=m.item.default_artifact||null,g=m.item.artifact_memory||null,p=m.item.editorial_pick||null;return`
        <button class="btn-clean discovery-link" data-mode="${m.mode}" data-slot="${m.slot}" data-game="${m.item.game_id}" data-spectator="${m.item.spectator_token||""}" data-phase="${(_==null?void 0:_.phase)||""}" data-layout="${(_==null?void 0:_.layout)||""}" data-slot-layout="${(_==null?void 0:_.slot_layout)||""}" style="text-align:left;padding:12px 14px;border-color:${m.accent}2e;background:${m.accent}12">
          ...
          ${p!=null&&p.action_label?`<div style="font-size:8px;color:#FCA5A5;font-weight:800;letter-spacing:0.7px;text-transform:uppercase;margin-top:8px">${p.action_label}</div>`:""}
          ...
          <div style="font-size:8px;color:var(--text-muted);line-height:1.45;margin-top:5px">${(p==null?void 0:p.format_summary)||(_==null?void 0:_.reason)||"Featured packaging is loading."}</div>
          <div style="font-size:9px;color:var(--text-muted);line-height:1.45;margin-top:6px">${(p==null?void 0:p.shelf_kicker)||m.item.story_hook||m.item.winner_summary||"Replay story is loading."}</div>
        </button>
      ...
      <div class="spectator-entry-card">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-top:14px">${f}</div>
    ...
    `,this._discoveryShelf.querySelectorAll(".discovery-link").forEach(m=>{m.addEventListener("click",()=>{const _=m.dataset.game,g=m.dataset.mode,p=m.dataset.spectator||null,y=m.dataset.slot||null,x=m.dataset.phase||null,v=m.dataset.layout||null,C=m.dataset.slotLayout||null;if(g==="slot"&&y){if(_&&(x||v)){this.store.watchGame(_,p,{viaSharedLink:!0,requestedPhase:x||"replay",layout:v||null,slot:y});return}this.store.openFeaturedSlot(y,{viaSharedLink:!0,layout:C||null});return}if(_){if(g==="replay"){this.store.watchGame(_,p,{viaSharedLink:!0,requestedPhase:"replay"});return}this.store.watchGame(_,p)}})})}_updateFeaturedReplayPage(e){var we,Re,Ne;if(!this._isFeaturedReplayPage(e)){this._featuredReplayPage.classList.add("hidden"),this._featuredReplayPage.innerHTML="";return}const t=e.gameData||{},n=t.summary||{},i=this.store.startupList||[],s=(t==null?void 0:t.rank_basis)==="score",o=this._isReplayCardLayout(e),a=this._isReplaySocialLayout(e),l=((we=e.entryContext)==null?void 0:we.slot)||null,c=l?this._slotTitle(l):null,d=l&&((Re=e.featuredFeed)==null?void 0:Re[l])||null,h=(d==null?void 0:d.editorial_pick)||null,u=(d==null?void 0:d.artifact_focus)||null,f=(d==null?void 0:d.artifact_memory)||null,m=i[0]||null,_=i[1]||null,g=this.store.getShareUrl({layout:null}),p=this.store.getShareUrl({layout:"card"}),y=this.store.getShareUrl({layout:"social"}),x=l?this.store.getFeaturedSlotUrl(l,{layout:null}):"",v=this.controls._buildSharePackage(t,n,i,s),C=this.controls._buildReplayRecapText(n,i,s),E=this._buildReplayEmbedSnippet(p,`${v.headline||"Founder Arena Featured Replay"}`),T=this._socialCaption(n,v.headline,v.storyHook),R=i.slice(0,3),S=c?a?`${c} Social`:o?`${c} Card`:c:a?"Social Card":o?"Replay Card":"Featured Replay Page",M=[c?`Slot: ${c}`:null,v.formatLabel,t.queue||"showmatch",t.benchmark_tier||"baseline",f!=null&&f.leader_label?`Slot memory: ${f.leader_label}`:null,`ID ${e.gameId||""}`].filter(Boolean).join(" · "),P=(h==null?void 0:h.shelf_kicker)||n.winner_summary||v.storyHook,O=(h==null?void 0:h.action_label)||"Open Recap",U=(h==null?void 0:h.why_today)||"",W=(h==null?void 0:h.format_summary)||"",q=(h==null?void 0:h.shelf_cta)||"";this._featuredReplayPage.classList.remove("hidden"),this._featuredReplayPage.innerHTML=`
      <div class="spectator-entry-card spectator-entry-card-replay" style="padding:${a?"22px 20px":o?"16px":"18px 20px"};max-width:${a?"760px":o?"780px":"none"};margin:${o||a?"0 auto":"0"};background:
        ...
        <div class="spectator-entry-hero" style="align-items:flex-start">
          <div style="flex:1 1 460px;min-width:0">
            <div style="font-size:9px;color:#22D3EE;font-weight:800;letter-spacing:0.9px;text-transform:uppercase">${v.matchupLabel}</div>
            <div class="spectator-entry-headline" style="font-size:${a?"30px":o?"22px":"26px"};line-height:1.15;margin-top:8px">${v.headline}</div>
            <div class="spectator-entry-subline" style="margin-top:10px;max-width:760px;line-height:1.6">${P}</div>
            ${v.deckLabel?`<div class="spectator-entry-subline" style="margin-top:8px;color:#CBD5E1">${v.deckLabel}</div>`:""}
            ...
            ${a?`<div style="margin-top:14px;padding:14px 16px;border-radius:14px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);font-size:11px;color:var(--text);line-height:1.65;white-space:pre-wrap">${T}</div>`:""}
          ...
          <div class="spectator-entry-scorecard" style="min-width:220px">
            ...
            <div class="spectator-entry-score" style="margin-top:8px">${(m==null?void 0:m.startup_name)||"Unknown"}</div>
            <div class="spectator-entry-score-meta">${(m==null?void 0:m.agent_name)||"Unknown founder"}</div>
        ...
        <div class="spectator-entry-summary-grid" style="margin-top:18px;grid-template-columns:${a?"repeat(2,minmax(0,1fr))":""}">
          <div class="spectator-entry-summary-cell">
            ...
            <div class="spectator-entry-cell-value">${v.formatLabel}</div>
          </div>
          <div class="spectator-entry-summary-cell">
            <div class="spectator-entry-cell-label">Winner</div>
            <div class="spectator-entry-cell-value">${(m==null?void 0:m.startup_name)||"Unknown"}</div>
          </div>
          <div class="spectator-entry-summary-cell">
          ...
          <div class="spectator-entry-summary-cell">
            ...
            <div class="spectator-entry-cell-value spectator-entry-cell-wrap">${v.storyHook||"Replay story is loading."}</div>
          </div>
          ...
          <div class="spectator-entry-summary-cell">
            ...
            <div class="spectator-entry-cell-value spectator-entry-cell-wrap">${((Ne=v.topTurningPoint)==null?void 0:Ne.headline)||"Turning points are loading."}</div>
          </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:${o||a?"1fr":"minmax(0,1.4fr) minmax(280px,0.9fr)"};gap:16px;margin-top:18px">
          <div style="display:grid;gap:16px">
            <div style="padding:14px 16px;border-radius:14px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06)">
              ...
              <div style="font-size:10px;color:var(--text-dim);line-height:1.65;margin-top:10px;white-space:pre-wrap">${C}</div>
            </div>
          ...
          <div style="display:grid;gap:16px">
            ...
            <div style="padding:14px 16px;border-radius:14px;background:rgba(34,211,238,0.06);border:1px solid rgba(34,211,238,0.14)">
              ...
              <div style="font-size:12px;color:var(--text);font-weight:800;line-height:1.45;margin-top:10px">${v.headline}</div>
              <div style="font-size:10px;color:var(--text-dim);line-height:1.6;white-space:pre-wrap;margin-top:10px">${v.caption}</div>
            </div>
            ...
            <div style="padding:14px 16px;border-radius:14px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06)">
              ...
              <div style="font-size:10px;color:var(--text-dim);line-height:1.6;word-break:break-word;margin-top:10px">${a?y:o?p:g||"No replay link available."}</div>
              ${x?`<div style="font-size:9px;color:var(--text-muted);line-height:1.5;margin-top:10px">Slot page: ${x}</div>`:""}
              ${!o&&!a?`<div style="font-size:9px;color:var(--text-muted);line-height:1.5;margin-top:10px">Card export: ${p}</div><div style="font-size:9px;color:var(--text-muted);line-height:1.5;margin-top:6px">Social export: ${y}</div>`:""}
            </div>
          </div>
        </div>
      </div>
    `;const $=this._featuredReplayPage.querySelector("#featured-open-recap"),Y=this._featuredReplayPage.querySelector("#featured-copy-link"),G=this._featuredReplayPage.querySelector("#featured-copy-slot-link"),se=this._featuredReplayPage.querySelector("#featured-copy-card-link"),ae=this._featuredReplayPage.querySelector("#featured-copy-social-link"),pe=this._featuredReplayPage.querySelector("#featured-copy-embed"),Pe=this._featuredReplayPage.querySelector("#featured-copy-cta"),$e=this._featuredReplayPage.querySelector("#featured-copy-headline"),X=this._featuredReplayPage.querySelector("#featured-copy-caption"),ee=this._featuredReplayPage.querySelector("#featured-copy-social-caption"),re=this._featuredReplayPage.querySelector("#featured-copy-package"),oe=this._featuredReplayPage.querySelector("#featured-copy-recap");$==null||$.addEventListener("click",()=>{this.controls.showPostGame({entryMode:"sharedReplay"})}),Y==null||Y.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(g||""),this._copyButtonFeedback(Y,"Copy Link","Link Copied")}catch{this._copyButtonFeedback(Y,"Copy Link","Copy Failed")}}),G==null||G.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(x||""),this._copyButtonFeedback(G,"Copy Slot Link","Slot Link Copied")}catch{this._copyButtonFeedback(G,"Copy Slot Link","Copy Failed")}}),se==null||se.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(p||""),this._copyButtonFeedback(se,"Copy Card Link","Card Link Copied")}catch{this._copyButtonFeedback(se,"Copy Card Link","Copy Failed")}}),ae==null||ae.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(y||""),this._copyButtonFeedback(ae,"Copy Social Link","Social Link Copied")}catch{this._copyButtonFeedback(ae,"Copy Social Link","Copy Failed")}}),pe==null||pe.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(E||""),this._copyButtonFeedback(pe,"Copy Embed","Embed Copied")}catch{this._copyButtonFeedback(pe,"Copy Embed","Copy Failed")}}),Pe==null||Pe.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(q||""),this._copyButtonFeedback(Pe,"Copy Today's CTA","CTA Copied")}catch{this._copyButtonFeedback(Pe,"Copy Today's CTA","Copy Failed")}}),$e==null||$e.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.headline||""),this._copyButtonFeedback($e,"Copy Headline","Headline Copied")}catch{this._copyButtonFeedback($e,"Copy Headline","Copy Failed")}}),X==null||X.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.caption||""),this._copyButtonFeedback(X,"Copy Caption","Caption Copied")}catch{this._copyButtonFeedback(X,"Copy Caption","Copy Failed")}}),ee==null||ee.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(T||""),this._copyButtonFeedback(ee,"Copy Social Caption","Social Caption Copied")}catch{this._copyButtonFeedback(ee,"Copy Social Caption","Copy Failed")}}),re==null||re.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.featuredCard||""),this._copyButtonFeedback(re,"Copy Package","Package Copied")}catch{this._copyButtonFeedback(re,"Copy Package","Copy Failed")}}),oe==null||oe.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(C||""),this._copyButtonFeedback(oe,"Copy Recap","Recap Copied")}catch{this._copyButtonFeedback(oe,"Copy Recap","Copy Failed")}}),this._featuredReplayPage.querySelectorAll(".featured-replay-select").forEach(Ue=>{Ue.addEventListener("click",()=>{var ot,F;const Ie=Ue.dataset.id;Ie&&(this.store.selectStartup(Ie),(F=(ot=this.scene)==null?void 0:ot.focusOnPod)==null||F.call(ot,Ie))})})}_updateFeaturedSlotPage(e){var q,$,Y,G,se,ae;if(!this._isFeaturedSlotPage(e)){this._featuredSlotPage.classList.add("hidden"),this._featuredSlotPage.innerHTML="";return}const t=(q=e.entryContext)==null?void 0:q.slot,n=e.featuredFeed||{},i=(n==null?void 0:n[t])||null,s=this._slotTitle(t),o=this.store.getFeaturedSlotUrl(t);if(this._featuredSlotPage.classList.remove("hidden"),!i){this._featuredSlotPage.innerHTML=`
      ...
      `;return}const a=`${window.location.origin}${window.location.pathname}?game=${encodeURIComponent(i.game_id)}${i.spectator_token?`&spectator=${encodeURIComponent(i.spectator_token)}`:""}&phase=replay`,l=i.default_artifact||null,c=i.artifact_memory||null,d=i.editorial_pick||null,h=(l==null?void 0:l.label)||"Featured Pick",u=(l==null?void 0:l.reason)||(($=i.artifact_focus)==null?void 0:$.reason)||"",f=(c==null?void 0:c.reason)||((Y=i.artifact_focus)==null?void 0:Y.memory_reason)||"",m=((G=e.entryContext)==null?void 0:G.layout)==="social"||!((se=e.entryContext)!=null&&se.layout)&&(l==null?void 0:l.slot_layout)==="social",_=this._artifactUrl(i,"card",`${a}&layout=card`),g=this._artifactUrl(i,"social",`${a}&layout=social`),p=this._queryUrlFromPayload(l==null?void 0:l.query)||g,y=this._buildReplayEmbedSnippet(_,`${s} | Founder Arena`),x=i.social_caption||[i.headline||`${i.winner_startup} won the match.`,i.winner_summary||null,i.story_hook?`Story hook: ${i.story_hook}`:null,i.turning_point_headline?`Turning point: ${i.turning_point_headline}`:null,i.practice_takeaway?`Takeaway: ${i.practice_takeaway}`:null].filter(Boolean).join(`
      ...
      <div class="spectator-entry-card spectator-entry-card-replay" style="padding:${m?"22px 20px":"18px 20px"};max-width:${m?"760px":"960px"};margin:0 auto;background:
        ...
        <div class="spectator-entry-hero" style="align-items:flex-start">
          <div style="flex:1 1 520px;min-width:0">
            ...
            ${f?`<div class="spectator-entry-subline" style="margin-top:8px;color:#93C5FD">Slot memory: ${f}</div>`:""}
        ...
        <div class="spectator-entry-summary-grid" style="margin-top:18px;grid-template-columns:${m?"repeat(2,minmax(0,1fr))":""}">
          ...
          <div class="spectator-entry-summary-cell">
            ...
            <div class="spectator-entry-cell-value spectator-entry-cell-wrap">${f||"Slot history is still warming up."}</div>
          </div>
          <div class="spectator-entry-summary-cell">
            <div class="spectator-entry-cell-label">Today&apos;s CTA</div>
...
`)}</div>
          ...
          <div style="display:grid;gap:16px">
            ...
            <div style="padding:14px 16px;border-radius:14px;background:rgba(252,211,77,0.06);border:1px solid rgba(252,211,77,0.14)">
              ...
              <div style="font-size:10px;color:var(--text-dim);line-height:1.6;word-break:break-word;margin-top:10px">${p}</div>
            </div>
            <div style="padding:14px 16px;border-radius:14px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06)">
