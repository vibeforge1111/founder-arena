...
`)+`
`+f);const x=y+g+o,v=y+f+a,C=Cl(i,i.VERTEX_SHADER,x),w=Cl(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(P){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(C).trim(),X=i.getShaderInfoLog(w).trim();let j=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(j=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,w);else{const Z=Ll(i,C,"vertex"),G=Ll(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function Tg(r,e,t){let n=new xa;const i=new _e,s=new _e,o=new je,a=new Mg({depthPacking:sh}),l=new Sg,c={},d=t.maxTextureSize,h={[Nn]:kt,[kt]:Nn,[It]:It},u=new Dt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new _e},radius:{value:4}},vertexShader:Eg,fragmentShader:wg}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const m=new _t;m.setAttribute("position",new pt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new H(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Rc;let f=this.type;this.render=function(w,A,R){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;const S=r.getRenderTarget(),M=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),z=r.state;z.setBlending(Pn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const O=f!==Tn&&this.type===Tn,X=f===Tn&&this.type!==Tn;for(let j=0,W=w.length;j<W;j++){const Z=w[j],G=Z.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;i.copy(G.mapSize);const oe=G.getFrameExtents();if(i.multiply(oe),s.copy(G.mapSize),(i.x>d||i.y>d)&&(i.x>d&&(s.x=Math.floor(d/oe.x),i.x=s.x*oe.x,G.mapSize.x=s.x),i.y>d&&(s.y=Math.floor(d/oe.y),i.y=s.y*oe.y,G.mapSize.y=s.y)),G.map===null||O===!0||X===!0){const be=this.type!==Tn?{minFilter:Bt,magFilter:Bt}:{};G.map!==null&&G.map.dispose(),G.map=new ln(i.x,i.y,be),G.map.texture.name=Z.name+".shadowMap",G.camera.updateProjectionMatrix()}r.setRenderTarget(G.map),r.clear();const pe=G.getViewportCount();for(let be=0;be<pe;be++){const Ue=G.getViewport(be);o.set(s.x*Ue.x,s.y*Ue.y,s.x*Ue.z,s.y*Ue.w),z.viewport(o),G.updateMatrices(Z,be),n=G.getFrustum(),v(A,R,G.camera,Z,this.type)}G.isPointLightShadow!==!0&&this.type===Tn&&y(G,R),G.needsUpdate=!1}f=this.type,g.needsUpdate=!1,r.setRenderTarget(S,M,P)};function y(w,A){const R=e.update(_);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new ln(i.x,i.y)),u.uniforms.shadow_pass.value=w.map.texture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,r.setRenderTarget(w.mapPass),r.clear(),r.renderBufferDirect(A,null,R,u,_,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,r.setRenderTarget(w.map),r.clear(),r.renderBufferDirect(A,null,R,p,_,null)}function x(w,A,R,S){let M=null;const P=R.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)M=P;else if(M=R.isPointLight===!0?l:a,r.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const z=M.uuid,O=A.uuid;let X=c[z];X===void 0&&(X={},c[z]=X);let j=X[O];j===void 0&&(j=M.clone(),X[O]=j,A.addEventListener("dispose",C)),M=j}if(M.visible=A.visible,M.wireframe=A.wireframe,S===Tn?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:h[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,R.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const z=r.properties.get(M);z.light=R}return M}function v(w,A,R,S,M){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===Tn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,w.matrixWorld);const O=e.update(w),X=w.material;if(Array.isArray(X)){const j=O.groups;for(let W=0,Z=j.length;W<Z;W++){const G=j[W],oe=X[G.materialIndex];if(oe&&oe.visible){const pe=x(w,oe,S,M);w.onBeforeShadow(r,w,A,R,O,pe,G),r.renderBufferDirect(R,null,O,pe,w,G),w.onAfterShadow(r,w,A,R,O,pe,G)}}}else if(X.visible){const j=x(w,X,S,M);w.onBeforeShadow(r,w,A,R,O,j,null),r.renderBufferDirect(R,null,O,j,w,null),w.onAfterShadow(r,w,A,R,O,j,null)}}const z=w.children;for(let O=0,X=z.length;O<X;O++)v(z[O],A,R,S,M)}function C(w){w.target.removeEventListener("dispose",C);for(const R in c){const S=c[R],M=w.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}const Ag={[_o]:vo,[xo]:Mo,[yo]:So,[Bi]:bo,[vo]:_o,[Mo]:xo,[So]:yo,[bo]:Bi};function Rg(r,e){function t(){let I=!1;const le=new je;let V=null;const K=new je(0,0,0,0);return{setMask:function(ue){V!==ue&&!I&&(r.colorMask(ue,ue,ue,ue),V=ue)},setLocked:function(ue){I=ue},setClear:function(ue,de,De,ft,Rt){Rt===!0&&(ue*=ft,de*=ft,De*=ft),le.set(ue,de,De,ft),K.equals(le)===!1&&(r.clearColor(ue,de,De,ft),K.copy(le))},reset:function(){I=!1,V=null,K.set(-1,0,0,0)}}}function n(){let I=!1,le=!1,V=null,K=null,ue=null;return{setReversed:function(de){if(le!==de){const De=e.get("EXT_clip_control");le?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT);const ft=ue;ue=null,this.setClear(ft)}le=de},getReversed:function(){return le},setTest:function(de){de?ae(r.DEPTH_TEST):Ee(r.DEPTH_TEST)},setMask:function(de){V!==de&&!I&&(r.depthMask(de),V=de)},setFunc:function(de){if(le&&(de=Ag[de]),K!==de){switch(de){case _o:r.depthFunc(r.NEVER);break;case vo:r.depthFunc(r.ALWAYS);break;case xo:r.depthFunc(r.LESS);break;case Bi:r.depthFunc(r.LEQUAL);break;case yo:r.depthFunc(r.EQUAL);break;case bo:r.depthFunc(r.GEQUAL);break;case Mo:r.depthFunc(r.GREATER);break;case So:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}K=de}},setLocked:function(de){I=de},setClear:function(de){ue!==de&&(le&&(de=1-de),r.clearDepth(de),ue=de)},reset:function(){I=!1,V=null,K=null,ue=null,le=!1}}}function i(){let I=!1,le=null,V=null,K=null,ue=null,de=null,De=null,ft=null,Rt=null;return{setTest:function(Qe){I||(Qe?ae(r.STENCIL_TEST):Ee(r.STENCIL_TEST))},setMask:function(Qe){le!==Qe&&!I&&(r.stencilMask(Qe),le=Qe)},setFunc:function(Qe,Zt,vn){(V!==Qe||K!==Zt||ue!==vn)&&(r.stencilFunc(Qe,Zt,vn),V=Qe,K=Zt,ue=vn)},setOp:function(Qe,Zt,vn){(de!==Qe||De!==Zt||ft!==vn)&&(r.stencilOp(Qe,Zt,vn),de=Qe,De=Zt,ft=vn)},setLocked:function(Qe){I=Qe},setClear:function(Qe){Rt!==Qe&&(r.clearStencil(Qe),Rt=Qe)},reset:function(){I=!1,le=null,V=null,K=null,ue=null,de=null,De=null,ft=null,Rt=null}}}const s=new t,o=new n,a=new i,l=new WeakMap,c=new WeakMap;let d={},h={},u=new WeakMap,p=[],m=null,_=!1,g=null,f=null,y=null,x=null,v=null,C=null,w=null,A=new Q(0,0,0),R=0,S=!1,M=null,P=null,z=null,O=null,X=null;const j=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,Z=0;const G=r.getParameter(r.VERSION);G.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(G)[1]),W=Z>=1):G.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),W=Z>=2);let oe=null,pe={};const be=r.getParameter(r.SCISSOR_BOX),Ue=r.getParameter(r.VIEWPORT),Ye=new je().fromArray(be),$=new je().fromArray(Ue);function ee(I,le,V,K){const ue=new Uint8Array(4),de=r.createTexture();r.bindTexture(I,de),r.texParameteri(I,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(I,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let De=0;De<V;De++)I===r.TEXTURE_3D||I===r.TEXTURE_2D_ARRAY?r.texImage3D(le,0,r.RGBA,1,1,K,0,r.RGBA,r.UNSIGNED_BYTE,ue):r.texImage2D(le+De,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ue);return de}const se={};se[r.TEXTURE_2D]=ee(r.TEXTURE_2D,r.TEXTURE_2D,1),se[r.TEXTURE_CUBE_MAP]=ee(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),se[r.TEXTURE_2D_ARRAY]=ee(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),se[r.TEXTURE_3D]=ee(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ae(r.DEPTH_TEST),o.setFunc(Bi),Ge(!1),Ve(za),ae(r.CULL_FACE),F(Pn);function ae(I){d[I]!==!0&&(r.enable(I),d[I]=!0)}function Ee(I){d[I]!==!1&&(r.disable(I),d[I]=!1)}function Pe(I,le){return h[I]!==le?(r.bindFramebuffer(I,le),h[I]=le,I===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=le),I===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=le),!0):!1}function Oe(I,le){let V=p,K=!1;if(I){V=u.get(le),V===void 0&&(V=[],u.set(le,V));const ue=I.textures;if(V.length!==ue.length||V[0]!==r.COLOR_ATTACHMENT0){for(let de=0,De=ue.length;de<De;de++)V[de]=r.COLOR_ATTACHMENT0+de;V.length=ue.length,K=!0}}else V[0]!==r.BACK&&(V[0]=r.BACK,K=!0);K&&r.drawBuffers(V)}function ut(I){return m!==I?(r.useProgram(I),m=I,!0):!1}const $e={[ai]:r.FUNC_ADD,[Nd]:r.FUNC_SUBTRACT,[Fd]:r.FUNC_REVERSE_SUBTRACT};$e[Ud]=r.MIN,$e[Od]=r.MAX;const gt={[kd]:r.ZERO,[Bd]:r.ONE,[zd]:r.SRC_COLOR,[mo]:r.SRC_ALPHA,[Xd]:r.SRC_ALPHA_SATURATE,[Wd]:r.DST_COLOR,[Gd]:r.DST_ALPHA,[Hd]:r.ONE_MINUS_SRC_COLOR,[go]:r.ONE_MINUS_SRC_ALPHA,[$d]:r.ONE_MINUS_DST_COLOR,[Vd]:r.ONE_MINUS_DST_ALPHA,[qd]:r.CONSTANT_COLOR,[jd]:r.ONE_MINUS_CONSTANT_COLOR,[Yd]:r.CONSTANT_ALPHA,[Kd]:r.ONE_MINUS_CONSTANT_ALPHA};function F(I,le,V,K,ue,de,De,ft,Rt,Qe){if(I===Pn){_===!0&&(Ee(r.BLEND),_=!1);return}if(_===!1&&(ae(r.BLEND),_=!0),I!==Dd){if(I!==g||Qe!==S){if((f!==ai||v!==ai)&&(r.blendEquation(r.FUNC_ADD),f=ai,v=ai),Qe)switch(I){case Ni:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case fo:r.blendFunc(r.ONE,r.ONE);break;case Ha:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ga:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case Ni:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case fo:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case Ha:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ga:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}y=null,x=null,C=null,w=null,A.set(0,0,0),R=0,g=I,S=Qe}return}ue=ue||le,de=de||V,De=De||K,(le!==f||ue!==v)&&(r.blendEquationSeparate($e[le],$e[ue]),f=le,v=ue),(V!==y||K!==x||de!==C||De!==w)&&(r.blendFuncSeparate(gt[V],gt[K],gt[de],gt[De]),y=V,x=K,C=de,w=De),(ft.equals(A)===!1||Rt!==R)&&(r.blendColor(ft.r,ft.g,ft.b,Rt),A.copy(ft),R=Rt),g=I,S=!1}function Xt(I,le){I.side===It?Ee(r.CULL_FACE):ae(r.CULL_FACE);let V=I.side===kt;le&&(V=!V),Ge(V),I.blending===Ni&&I.transparent===!1?F(Pn):F(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),s.setMask(I.colorWrite);const K=I.stencilWrite;a.setTest(K),K&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),at(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ae(r.SAMPLE_ALPHA_TO_COVERAGE):Ee(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(I){M!==I&&(I?r.frontFace(r.CW):r.frontFace(r.CCW),M=I)}function Ve(I){I!==Ld?(ae(r.CULL_FACE),I!==P&&(I===za?r.cullFace(r.BACK):I===Id?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ee(r.CULL_FACE),P=I}function Ae(I){I!==z&&(W&&r.lineWidth(I),z=I)}function at(I,le,V){I?(ae(r.POLYGON_OFFSET_FILL),(O!==le||X!==V)&&(r.polygonOffset(le,V),O=le,X=V)):Ee(r.POLYGON_OFFSET_FILL)}function we(I){I?ae(r.SCISSOR_TEST):Ee(r.SCISSOR_TEST)}function T(I){I===void 0&&(I=r.TEXTURE0+j-1),oe!==I&&(r.activeTexture(I),oe=I)}function b(I,le,V){V===void 0&&(oe===null?V=r.TEXTURE0+j-1:V=oe);let K=pe[V];K===void 0&&(K={type:void 0,texture:void 0},pe[V]=K),(K.type!==I||K.texture!==le)&&(oe!==V&&(r.activeTexture(V),oe=V),r.bindTexture(I,le||se[I]),K.type=I,K.texture=le)}function U(){const I=pe[oe];I!==void 0&&I.type!==void 0&&(r.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function Y(){try{r.compressedTexImage2D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function J(){try{r.compressedTexImage3D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function q(){try{r.texSubImage2D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Me(){try{r.texSubImage3D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ce(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function fe(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Xe(){try{r.texStorage2D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function te(){try{r.texStorage3D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function me(){try{r.texImage2D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Re(){try{r.texImage3D.apply(r,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ce(I){Ye.equals(I)===!1&&(r.scissor(I.x,I.y,I.z,I.w),Ye.copy(I))}function ge(I){$.equals(I)===!1&&(r.viewport(I.x,I.y,I.z,I.w),$.copy(I))}function We(I,le){let V=c.get(le);V===void 0&&(V=new WeakMap,c.set(le,V));let K=V.get(I);K===void 0&&(K=r.getUniformBlockIndex(le,I.name),V.set(I,K))}function ke(I,le){const K=c.get(le).get(I);l.get(le)!==K&&(r.uniformBlockBinding(le,K,I.__bindingPointIndex),l.set(le,K))}function rt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),d={},oe=null,pe={},h={},u=new WeakMap,p=[],m=null,_=!1,g=null,f=null,y=null,x=null,v=null,C=null,w=null,A=new Q(0,0,0),R=0,S=!1,M=null,P=null,z=null,O=null,X=null,Ye.set(0,0,r.canvas.width,r.canvas.height),$.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ae,disable:Ee,bindFramebuffer:Pe,drawBuffers:Oe,useProgram:ut,setBlending:F,setMaterial:Xt,setFlipSided:Ge,setCullFace:Ve,setLineWidth:Ae,setPolygonOffset:at,setScissorTest:we,activeTexture:T,bindTexture:b,unbindTexture:U,compressedTexImage2D:Y,compressedTexImage3D:J,texImage2D:me,texImage3D:Re,updateUBOMapping:We,uniformBlockBinding:ke,texStorage2D:Xe,texStorage3D:te,texSubImage2D:q,texSubImage3D:Me,compressedTexSubImage2D:ce,compressedTexSubImage3D:fe,scissor:Ce,viewport:ge,reset:rt}}function Bl(r,e,t,n){const i=Cg(n);switch(t){case Hc:return r*e;case Vc:return r*e;case Wc:return r*e*2;case pa:return r*e/i.components*i.byteLength;case fa:return r*e/i.components*i.byteLength;case $c:return r*e*2/i.components*i.byteLength;case ma:return r*e*2/i.components*i.byteLength;case Gc:return r*e*3/i.components*i.byteLength;case Kt:return r*e*4/i.components*i.byteLength;case ga:return r*e*4/i.components*i.byteLength;case lr:case cr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case dr:case hr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Ao:case Co:return Math.max(r,16)*Math.max(e,8)/4;case To:case Ro:return Math.max(r,8)*Math.max(e,8)/2;case Po:case Lo:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case Io:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Do:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case No:return Math.floor((r+4)/5)*Math.floor((e+3)/4)*16;case Fo:return Math.floor((r+4)/5)*Math.floor((e+4)/5)*16;case Uo:return Math.floor((r+5)/6)*Math.floor((e+4)/5)*16;case Oo:return Math.floor((r+5)/6)*Math.floor((e+5)/6)*16;case ko:return Math.floor((r+7)/8)*Math.floor((e+4)/5)*16;case Bo:return Math.floor((r+7)/8)*Math.floor((e+5)/6)*16;case zo:return Math.floor((r+7)/8)*Math.floor((e+7)/8)*16;case Ho:return Math.floor((r+9)/10)*Math.floor((e+4)/5)*16;case Go:return Math.floor((r+9)/10)*Math.floor((e+5)/6)*16;case Vo:return Math.floor((r+9)/10)*Math.floor((e+7)/8)*16;case Wo:return Math.floor((r+9)/10)*Math.floor((e+9)/10)*16;case $o:return Math.floor((r+11)/12)*Math.floor((e+9)/10)*16;case Xo:return Math.floor((r+11)/12)*Math.floor((e+11)/12)*16;case ur:case qo:case jo:return Math.ceil(r/4)*Math.ceil(e/4)*16;case Xc:case Yo:return Math.ceil(r/4)*Math.ceil(e/4)*8;case Ko:case Zo:return Math.ceil(r/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Cg(r){switch(r){case Fn:case kc:return{byteLength:1,components:1};case ys:case Bc:case Ln:return{byteLength:2,components:1};case ha:case ua:return{byteLength:2,components:4};case ci:case da:case rn:return{byteLength:4,components:1};case zc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function Pg(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new _e,d=new WeakMap;let h;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(T,b){return p?new OffscreenCanvas(T,b):Ss("canvas")}function _(T,b,U){let Y=1;const J=we(T);if((J.width>U||J.height>U)&&(Y=U/Math.max(J.width,J.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const q=Math.floor(Y*J.width),Me=Math.floor(Y*J.height);h===void 0&&(h=m(q,Me));const ce=b?m(q,Me):h;return ce.width=q,ce.height=Me,ce.getContext("2d").drawImage(T,0,0,q,Me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+q+"x"+Me+")."),ce}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),T;return T}function g(T){return T.generateMipmaps}function f(T){r.generateMipmap(T)}function y(T){return T.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?r.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function x(T,b,U,Y,J=!1){if(T!==null){if(r[T]!==void 0)return r[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let q=b;if(b===r.RED&&(U===r.FLOAT&&(q=r.R32F),U===r.HALF_FLOAT&&(q=r.R16F),U===r.UNSIGNED_BYTE&&(q=r.R8)),b===r.RED_INTEGER&&(U===r.UNSIGNED_BYTE&&(q=r.R8UI),U===r.UNSIGNED_SHORT&&(q=r.R16UI),U===r.UNSIGNED_INT&&(q=r.R32UI),U===r.BYTE&&(q=r.R8I),U===r.SHORT&&(q=r.R16I),U===r.INT&&(q=r.R32I)),b===r.RG&&(U===r.FLOAT&&(q=r.RG32F),U===r.HALF_FLOAT&&(q=r.RG16F),U===r.UNSIGNED_BYTE&&(q=r.RG8)),b===r.RG_INTEGER&&(U===r.UNSIGNED_BYTE&&(q=r.RG8UI),U===r.UNSIGNED_SHORT&&(q=r.RG16UI),U===r.UNSIGNED_INT&&(q=r.RG32UI),U===r.BYTE&&(q=r.RG8I),U===r.SHORT&&(q=r.RG16I),U===r.INT&&(q=r.RG32I)),b===r.RGB_INTEGER&&(U===r.UNSIGNED_BYTE&&(q=r.RGB8UI),U===r.UNSIGNED_SHORT&&(q=r.RGB16UI),U===r.UNSIGNED_INT&&(q=r.RGB32UI),U===r.BYTE&&(q=r.RGB8I),U===r.SHORT&&(q=r.RGB16I),U===r.INT&&(q=r.RGB32I)),b===r.RGBA_INTEGER&&(U===r.UNSIGNED_BYTE&&(q=r.RGBA8UI),U===r.UNSIGNED_SHORT&&(q=r.RGBA16UI),U===r.UNSIGNED_INT&&(q=r.RGBA32UI),U===r.BYTE&&(q=r.RGBA8I),U===r.SHORT&&(q=r.RGBA16I),U===r.INT&&(q=r.RGBA32I)),b===r.RGB&&U===r.UNSIGNED_INT_5_9_9_9_REV&&(q=r.RGB9_E5),b===r.RGBA){const Me=J?br:ze.getTransfer(Y);U===r.FLOAT&&(q=r.RGBA32F),U===r.HALF_FLOAT&&(q=r.RGBA16F),U===r.UNSIGNED_BYTE&&(q=Me===et?r.SRGB8_ALPHA8:r.RGBA8),U===r.UNSIGNED_SHORT_4_4_4_4&&(q=r.RGBA4),U===r.UNSIGNED_SHORT_5_5_5_1&&(q=r.RGB5_A1)}return(q===r.R16F||q===r.R32F||q===r.RG16F||q===r.RG32F||q===r.RGBA16F||q===r.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function v(T,b){let U;return T?b===null||b===ci||b===Vi?U=r.DEPTH24_STENCIL8:b===rn?U=r.DEPTH32F_STENCIL8:b===ys&&(U=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===ci||b===Vi?U=r.DEPTH_COMPONENT24:b===rn?U=r.DEPTH_COMPONENT32F:b===ys&&(U=r.DEPTH_COMPONENT16),U}function C(T,b){return g(T)===!0||T.isFramebufferTexture&&T.minFilter!==Bt&&T.minFilter!==$t?Math.log2(Math.max(b.width,b.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?b.mipmaps.length:1}function w(T){const b=T.target;b.removeEventListener("dispose",w),R(b),b.isVideoTexture&&d.delete(b)}function A(T){const b=T.target;b.removeEventListener("dispose",A),M(b)}function R(T){const b=n.get(T);if(b.__webglInit===void 0)return;const U=T.source,Y=u.get(U);if(Y){const J=Y[b.__cacheKey];J.usedTimes--,J.usedTimes===0&&S(T),Object.keys(Y).length===0&&u.delete(U)}n.remove(T)}function S(T){const b=n.get(T);r.deleteTexture(b.__webglTexture);const U=T.source,Y=u.get(U);delete Y[b.__cacheKey],o.memory.textures--}function M(T){const b=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(b.__webglFramebuffer[Y]))for(let J=0;J<b.__webglFramebuffer[Y].length;J++)r.deleteFramebuffer(b.__webglFramebuffer[Y][J]);else r.deleteFramebuffer(b.__webglFramebuffer[Y]);b.__webglDepthbuffer&&r.deleteRenderbuffer(b.__webglDepthbuffer[Y])}else{if(Array.isArray(b.__webglFramebuffer))for(let Y=0;Y<b.__webglFramebuffer.length;Y++)r.deleteFramebuffer(b.__webglFramebuffer[Y]);else r.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&r.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&r.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let Y=0;Y<b.__webglColorRenderbuffer.length;Y++)b.__webglColorRenderbuffer[Y]&&r.deleteRenderbuffer(b.__webglColorRenderbuffer[Y]);b.__webglDepthRenderbuffer&&r.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const U=T.textures;for(let Y=0,J=U.length;Y<J;Y++){const q=n.get(U[Y]);q.__webglTexture&&(r.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(U[Y])}n.remove(T)}let P=0;function z(){P=0}function O(){const T=P;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),P+=1,T}function X(T){const b=[];return b.push(T.wrapS),b.push(T.wrapT),b.push(T.wrapR||0),b.push(T.magFilter),b.push(T.minFilter),b.push(T.anisotropy),b.push(T.internalFormat),b.push(T.format),b.push(T.type),b.push(T.generateMipmaps),b.push(T.premultiplyAlpha),b.push(T.flipY),b.push(T.unpackAlignment),b.push(T.colorSpace),b.join()}function j(T,b){const U=n.get(T);if(T.isVideoTexture&&Ae(T),T.isRenderTargetTexture===!1&&T.version>0&&U.__version!==T.version){const Y=T.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(U,T,b);return}}t.bindTexture(r.TEXTURE_2D,U.__webglTexture,r.TEXTURE0+b)}function W(T,b){const U=n.get(T);if(T.version>0&&U.__version!==T.version){$(U,T,b);return}t.bindTexture(r.TEXTURE_2D_ARRAY,U.__webglTexture,r.TEXTURE0+b)}function Z(T,b){const U=n.get(T);if(T.version>0&&U.__version!==T.version){$(U,T,b);return}t.bindTexture(r.TEXTURE_3D,U.__webglTexture,r.TEXTURE0+b)}function G(T,b){const U=n.get(T);if(T.version>0&&U.__version!==T.version){ee(U,T,b);return}t.bindTexture(r.TEXTURE_CUBE_MAP,U.__webglTexture,r.TEXTURE0+b)}const oe={[Gi]:r.REPEAT,[jn]:r.CLAMP_TO_EDGE,[fr]:r.MIRRORED_REPEAT},pe={[Bt]:r.NEAREST,[Oc]:r.NEAREST_MIPMAP_NEAREST,[fs]:r.NEAREST_MIPMAP_LINEAR,[$t]:r.LINEAR,[ar]:r.LINEAR_MIPMAP_NEAREST,[Rn]:r.LINEAR_MIPMAP_LINEAR},be={[oh]:r.NEVER,[uh]:r.ALWAYS,[ah]:r.LESS,[Yc]:r.LEQUAL,[lh]:r.EQUAL,[hh]:r.GEQUAL,[ch]:r.GREATER,[dh]:r.NOTEQUAL};function Ue(T,b){if(b.type===rn&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===$t||b.magFilter===ar||b.magFilter===fs||b.magFilter===Rn||b.minFilter===$t||b.minFilter===ar||b.minFilter===fs||b.minFilter===Rn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(T,r.TEXTURE_WRAP_S,oe[b.wrapS]),r.texParameteri(T,r.TEXTURE_WRAP_T,oe[b.wrapT]),(T===r.TEXTURE_3D||T===r.TEXTURE_2D_ARRAY)&&r.texParameteri(T,r.TEXTURE_WRAP_R,oe[b.wrapR]),r.texParameteri(T,r.TEXTURE_MAG_FILTER,pe[b.magFilter]),r.texParameteri(T,r.TEXTURE_MIN_FILTER,pe[b.minFilter]),b.compareFunction&&(r.texParameteri(T,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(T,r.TEXTURE_COMPARE_FUNC,be[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===Bt||b.minFilter!==fs&&b.minFilter!==Rn||b.type===rn&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");r.texParameterf(T,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,i.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function Ye(T,b){let U=!1;T.__webglInit===void 0&&(T.__webglInit=!0,b.addEventListener("dispose",w));const Y=b.source;let J=u.get(Y);J===void 0&&(J={},u.set(Y,J));const q=X(b);if(q!==T.__cacheKey){J[q]===void 0&&(J[q]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,U=!0),J[q].usedTimes++;const Me=J[T.__cacheKey];Me!==void 0&&(J[T.__cacheKey].usedTimes--,Me.usedTimes===0&&S(b)),T.__cacheKey=q,T.__webglTexture=J[q].texture}return U}function $(T,b,U){let Y=r.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(Y=r.TEXTURE_2D_ARRAY),b.isData3DTexture&&(Y=r.TEXTURE_3D);const J=Ye(T,b),q=b.source;t.bindTexture(Y,T.__webglTexture,r.TEXTURE0+U);const Me=n.get(q);if(q.version!==Me.__version||J===!0){t.activeTexture(r.TEXTURE0+U);const ce=ze.getPrimaries(ze.workingColorSpace),fe=b.colorSpace===qn?null:ze.getPrimaries(b.colorSpace),Xe=b.colorSpace===qn||ce===fe?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,b.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,b.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xe);let te=_(b.image,!1,i.maxTextureSize);te=at(b,te);const me=s.convert(b.format,b.colorSpace),Re=s.convert(b.type);let Ce=x(b.internalFormat,me,Re,b.colorSpace,b.isVideoTexture);Ue(Y,b);let ge;const We=b.mipmaps,ke=b.isVideoTexture!==!0,rt=Me.__version===void 0||J===!0,I=q.dataReady,le=C(b,te);if(b.isDepthTexture)Ce=v(b.format===Wi,b.type),rt&&(ke?t.texStorage2D(r.TEXTURE_2D,1,Ce,te.width,te.height):t.texImage2D(r.TEXTURE_2D,0,Ce,te.width,te.height,0,me,Re,null));else if(b.isDataTexture)if(We.length>0){ke&&rt&&t.texStorage2D(r.TEXTURE_2D,le,Ce,We[0].width,We[0].height);for(let V=0,K=We.length;V<K;V++)ge=We[V],ke?I&&t.texSubImage2D(r.TEXTURE_2D,V,0,0,ge.width,ge.height,me,Re,ge.data):t.texImage2D(r.TEXTURE_2D,V,Ce,ge.width,ge.height,0,me,Re,ge.data);b.generateMipmaps=!1}else ke?(rt&&t.texStorage2D(r.TEXTURE_2D,le,Ce,te.width,te.height),I&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,te.width,te.height,me,Re,te.data)):t.texImage2D(r.TEXTURE_2D,0,Ce,te.width,te.height,0,me,Re,te.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){ke&&rt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,le,Ce,We[0].width,We[0].height,te.depth);for(let V=0,K=We.length;V<K;V++)if(ge=We[V],b.format!==Kt)if(me!==null)if(ke){if(I)if(b.layerUpdates.size>0){const ue=Bl(ge.width,ge.height,b.format,b.type);for(const de of b.layerUpdates){const De=ge.data.subarray(de*ue/ge.data.BYTES_PER_ELEMENT,(de+1)*ue/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,de,ge.width,ge.height,1,me,De)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,0,ge.width,ge.height,te.depth,me,ge.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,V,Ce,ge.width,ge.height,te.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?I&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,V,0,0,0,ge.width,ge.height,te.depth,me,Re,ge.data):t.texImage3D(r.TEXTURE_2D_ARRAY,V,Ce,ge.width,ge.height,te.depth,0,me,Re,ge.data)}else{ke&&rt&&t.texStorage2D(r.TEXTURE_2D,le,Ce,We[0].width,We[0].height);for(let V=0,K=We.length;V<K;V++)ge=We[V],b.format!==Kt?me!==null?ke?I&&t.compressedTexSubImage2D(r.TEXTURE_2D,V,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(r.TEXTURE_2D,V,Ce,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?I&&t.texSubImage2D(r.TEXTURE_2D,V,0,0,ge.width,ge.height,me,Re,ge.data):t.texImage2D(r.TEXTURE_2D,V,Ce,ge.width,ge.height,0,me,Re,ge.data)}else if(b.isDataArrayTexture)if(ke){if(rt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,le,Ce,te.width,te.height,te.depth),I)if(b.layerUpdates.size>0){const V=Bl(te.width,te.height,b.format,b.type);for(const K of b.layerUpdates){const ue=te.data.subarray(K*V/te.data.BYTES_PER_ELEMENT,(K+1)*V/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,K,te.width,te.height,1,me,Re,ue)}b.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,me,Re,te.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Ce,te.width,te.height,te.depth,0,me,Re,te.data);else if(b.isData3DTexture)ke?(rt&&t.texStorage3D(r.TEXTURE_3D,le,Ce,te.width,te.height,te.depth),I&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,me,Re,te.data)):t.texImage3D(r.TEXTURE_3D,0,Ce,te.width,te.height,te.depth,0,me,Re,te.data);else if(b.isFramebufferTexture){if(rt)if(ke)t.texStorage2D(r.TEXTURE_2D,le,Ce,te.width,te.height);else{let V=te.width,K=te.height;for(let ue=0;ue<le;ue++)t.texImage2D(r.TEXTURE_2D,ue,Ce,V,K,0,me,Re,null),V>>=1,K>>=1}}else if(We.length>0){if(ke&&rt){const V=we(We[0]);t.texStorage2D(r.TEXTURE_2D,le,Ce,V.width,V.height)}for(let V=0,K=We.length;V<K;V++)ge=We[V],ke?I&&t.texSubImage2D(r.TEXTURE_2D,V,0,0,me,Re,ge):t.texImage2D(r.TEXTURE_2D,V,Ce,me,Re,ge);b.generateMipmaps=!1}else if(ke){if(rt){const V=we(te);t.texStorage2D(r.TEXTURE_2D,le,Ce,V.width,V.height)}I&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,me,Re,te)}else t.texImage2D(r.TEXTURE_2D,0,Ce,me,Re,te);g(b)&&f(Y),Me.__version=q.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ee(T,b,U){if(b.image.length!==6)return;const Y=Ye(T,b),J=b.source;t.bindTexture(r.TEXTURE_CUBE_MAP,T.__webglTexture,r.TEXTURE0+U);const q=n.get(J);if(J.version!==q.__version||Y===!0){t.activeTexture(r.TEXTURE0+U);const Me=ze.getPrimaries(ze.workingColorSpace),ce=b.colorSpace===qn?null:ze.getPrimaries(b.colorSpace),fe=b.colorSpace===qn||Me===ce?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,b.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,b.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const Xe=b.isCompressedTexture||b.image[0].isCompressedTexture,te=b.image[0]&&b.image[0].isDataTexture,me=[];for(let K=0;K<6;K++)!Xe&&!te?me[K]=_(b.image[K],!0,i.maxCubemapSize):me[K]=te?b.image[K].image:b.image[K],me[K]=at(b,me[K]);const Re=me[0],Ce=s.convert(b.format,b.colorSpace),ge=s.convert(b.type),We=x(b.internalFormat,Ce,ge,b.colorSpace),ke=b.isVideoTexture!==!0,rt=q.__version===void 0||Y===!0,I=J.dataReady;let le=C(b,Re);Ue(r.TEXTURE_CUBE_MAP,b);let V;if(Xe){ke&&rt&&t.texStorage2D(r.TEXTURE_CUBE_MAP,le,We,Re.width,Re.height);for(let K=0;K<6;K++){V=me[K].mipmaps;for(let ue=0;ue<V.length;ue++){const de=V[ue];b.format!==Kt?Ce!==null?ke?I&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,0,0,de.width,de.height,Ce,de.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,We,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ke?I&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,0,0,de.width,de.height,Ce,ge,de.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,We,de.width,de.height,0,Ce,ge,de.data)}}}else{if(V=b.mipmaps,ke&&rt){V.length>0&&le++;const K=we(me[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,le,We,K.width,K.height)}for(let K=0;K<6;K++)if(te){ke?I&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,me[K].width,me[K].height,Ce,ge,me[K].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,We,me[K].width,me[K].height,0,Ce,ge,me[K].data);for(let ue=0;ue<V.length;ue++){const De=V[ue].image[K].image;ke?I&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,0,0,De.width,De.height,Ce,ge,De.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,We,De.width,De.height,0,Ce,ge,De.data)}}else{ke?I&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Ce,ge,me[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,We,Ce,ge,me[K]);for(let ue=0;ue<V.length;ue++){const de=V[ue];ke?I&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,0,0,Ce,ge,de.image[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,We,Ce,ge,de.image[K])}}}g(b)&&f(r.TEXTURE_CUBE_MAP),q.__version=J.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function se(T,b,U,Y,J,q){const Me=s.convert(U.format,U.colorSpace),ce=s.convert(U.type),fe=x(U.internalFormat,Me,ce,U.colorSpace),Xe=n.get(b),te=n.get(U);if(te.__renderTarget=b,!Xe.__hasExternalTextures){const me=Math.max(1,b.width>>q),Re=Math.max(1,b.height>>q);J===r.TEXTURE_3D||J===r.TEXTURE_2D_ARRAY?t.texImage3D(J,q,fe,me,Re,b.depth,0,Me,ce,null):t.texImage2D(J,q,fe,me,Re,0,Me,ce,null)}t.bindFramebuffer(r.FRAMEBUFFER,T),Ve(b)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Y,J,te.__webglTexture,0,Ge(b)):(J===r.TEXTURE_2D||J>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Y,J,te.__webglTexture,q),t.bindFramebuffer(r.FRAMEBUFFER,null)}function ae(T,b,U){if(r.bindRenderbuffer(r.RENDERBUFFER,T),b.depthBuffer){const Y=b.depthTexture,J=Y&&Y.isDepthTexture?Y.type:null,q=v(b.stencilBuffer,J),Me=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ce=Ge(b);Ve(b)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ce,q,b.width,b.height):U?r.renderbufferStorageMultisample(r.RENDERBUFFER,ce,q,b.width,b.height):r.renderbufferStorage(r.RENDERBUFFER,q,b.width,b.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Me,r.RENDERBUFFER,T)}else{const Y=b.textures;for(let J=0;J<Y.length;J++){const q=Y[J],Me=s.convert(q.format,q.colorSpace),ce=s.convert(q.type),fe=x(q.internalFormat,Me,ce,q.colorSpace),Xe=Ge(b);U&&Ve(b)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Xe,fe,b.width,b.height):Ve(b)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Xe,fe,b.width,b.height):r.renderbufferStorage(r.RENDERBUFFER,fe,b.width,b.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Ee(T,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,T),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(b.depthTexture);Y.__renderTarget=b,(!Y.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),j(b.depthTexture,0);const J=Y.__webglTexture,q=Ge(b);if(b.depthTexture.format===Fi)Ve(b)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,J,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,J,0);else if(b.depthTexture.format===Wi)Ve(b)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,J,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Pe(T){const b=n.get(T),U=T.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==T.depthTexture){const Y=T.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),Y){const J=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,Y.removeEventListener("dispose",J)};Y.addEventListener("dispose",J),b.__depthDisposeCallback=J}b.__boundDepthTexture=Y}if(T.depthTexture&&!b.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");Ee(b.__webglFramebuffer,T)}else if(U){b.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer[Y]),b.__webglDepthbuffer[Y]===void 0)b.__webglDepthbuffer[Y]=r.createRenderbuffer(),ae(b.__webglDepthbuffer[Y],T,!1);else{const J=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,q=b.__webglDepthbuffer[Y];r.bindRenderbuffer(r.RENDERBUFFER,q),r.framebufferRenderbuffer(r.FRAMEBUFFER,J,r.RENDERBUFFER,q)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=r.createRenderbuffer(),ae(b.__webglDepthbuffer,T,!1);else{const Y=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,J=b.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,J),r.framebufferRenderbuffer(r.FRAMEBUFFER,Y,r.RENDERBUFFER,J)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function Oe(T,b,U){const Y=n.get(T);b!==void 0&&se(Y.__webglFramebuffer,T,T.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),U!==void 0&&Pe(T)}function ut(T){const b=T.texture,U=n.get(T),Y=n.get(b);T.addEventListener("dispose",A);const J=T.textures,q=T.isWebGLCubeRenderTarget===!0,Me=J.length>1;if(Me||(Y.__webglTexture===void 0&&(Y.__webglTexture=r.createTexture()),Y.__version=b.version,o.memory.textures++),q){U.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(b.mipmaps&&b.mipmaps.length>0){U.__webglFramebuffer[ce]=[];for(let fe=0;fe<b.mipmaps.length;fe++)U.__webglFramebuffer[ce][fe]=r.createFramebuffer()}else U.__webglFramebuffer[ce]=r.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){U.__webglFramebuffer=[];for(let ce=0;ce<b.mipmaps.length;ce++)U.__webglFramebuffer[ce]=r.createFramebuffer()}else U.__webglFramebuffer=r.createFramebuffer();if(Me)for(let ce=0,fe=J.length;ce<fe;ce++){const Xe=n.get(J[ce]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=r.createTexture(),o.memory.textures++)}if(T.samples>0&&Ve(T)===!1){U.__webglMultisampledFramebuffer=r.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let ce=0;ce<J.length;ce++){const fe=J[ce];U.__webglColorRenderbuffer[ce]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,U.__webglColorRenderbuffer[ce]);const Xe=s.convert(fe.format,fe.colorSpace),te=s.convert(fe.type),me=x(fe.internalFormat,Xe,te,fe.colorSpace,T.isXRRenderTarget===!0),Re=Ge(T);r.renderbufferStorageMultisample(r.RENDERBUFFER,Re,me,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.RENDERBUFFER,U.__webglColorRenderbuffer[ce])}r.bindRenderbuffer(r.RENDERBUFFER,null),T.depthBuffer&&(U.__webglDepthRenderbuffer=r.createRenderbuffer(),ae(U.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(q){t.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture),Ue(r.TEXTURE_CUBE_MAP,b);for(let ce=0;ce<6;ce++)if(b.mipmaps&&b.mipmaps.length>0)for(let fe=0;fe<b.mipmaps.length;fe++)se(U.__webglFramebuffer[ce][fe],T,b,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ce,fe);else se(U.__webglFramebuffer[ce],T,b,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);g(b)&&f(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let ce=0,fe=J.length;ce<fe;ce++){const Xe=J[ce],te=n.get(Xe);t.bindTexture(r.TEXTURE_2D,te.__webglTexture),Ue(r.TEXTURE_2D,Xe),se(U.__webglFramebuffer,T,Xe,r.COLOR_ATTACHMENT0+ce,r.TEXTURE_2D,0),g(Xe)&&f(r.TEXTURE_2D)}t.unbindTexture()}else{let ce=r.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ce=T.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ce,Y.__webglTexture),Ue(ce,b),b.mipmaps&&b.mipmaps.length>0)for(let fe=0;fe<b.mipmaps.length;fe++)se(U.__webglFramebuffer[fe],T,b,r.COLOR_ATTACHMENT0,ce,fe);else se(U.__webglFramebuffer,T,b,r.COLOR_ATTACHMENT0,ce,0);g(b)&&f(ce),t.unbindTexture()}T.depthBuffer&&Pe(T)}function $e(T){const b=T.textures;for(let U=0,Y=b.length;U<Y;U++){const J=b[U];if(g(J)){const q=y(T),Me=n.get(J).__webglTexture;t.bindTexture(q,Me),f(q),t.unbindTexture()}}}const gt=[],F=[];function Xt(T){if(T.samples>0){if(Ve(T)===!1){const b=T.textures,U=T.width,Y=T.height;let J=r.COLOR_BUFFER_BIT;const q=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Me=n.get(T),ce=b.length>1;if(ce)for(let fe=0;fe<b.length;fe++)t.bindFramebuffer(r.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Me.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let fe=0;fe<b.length;fe++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(J|=r.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(J|=r.STENCIL_BUFFER_BIT)),ce){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Me.__webglColorRenderbuffer[fe]);const Xe=n.get(b[fe]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Xe,0)}r.blitFramebuffer(0,0,U,Y,0,0,U,Y,J,r.NEAREST),l===!0&&(gt.length=0,F.length=0,gt.push(r.COLOR_ATTACHMENT0+fe),T.depthBuffer&&T.resolveDepthBuffer===!1&&(gt.push(q),F.push(q),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,F)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,gt))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ce)for(let fe=0;fe<b.length;fe++){t.bindFramebuffer(r.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,Me.__webglColorRenderbuffer[fe]);const Xe=n.get(b[fe]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Me.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.TEXTURE_2D,Xe,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const b=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[b])}}}function Ge(T){return Math.min(i.maxSamples,T.samples)}function Ve(T){const b=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Ae(T){const b=o.render.frame;d.get(T)!==b&&(d.set(T,b),T.update())}function at(T,b){const U=T.colorSpace,Y=T.format,J=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||U!==Nt&&U!==qn&&(ze.getTransfer(U)===et?(Y!==Kt||J!==Fn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),b}function we(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=z,this.setTexture2D=j,this.setTexture2DArray=W,this.setTexture3D=Z,this.setTextureCube=G,this.rebindTextures=Oe,this.setupRenderTarget=ut,this.updateRenderTargetMipmap=$e,this.updateMultisampleRenderTarget=Xt,this.setupDepthRenderbuffer=Pe,this.setupFrameBufferTexture=se,this.useMultisampledRTT=Ve}function Lg(r,e){function t(n,i=qn){let s;const o=ze.getTransfer(i);if(n===Fn)return r.UNSIGNED_BYTE;if(n===ha)return r.UNSIGNED_SHORT_4_4_4_4;if(n===ua)return r.UNSIGNED_SHORT_5_5_5_1;if(n===zc)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===kc)return r.BYTE;if(n===Bc)return r.SHORT;if(n===ys)return r.UNSIGNED_SHORT;if(n===da)return r.INT;if(n===ci)return r.UNSIGNED_INT;if(n===rn)return r.FLOAT;if(n===Ln)return r.HALF_FLOAT;if(n===Hc)return r.ALPHA;if(n===Gc)return r.RGB;if(n===Kt)return r.RGBA;if(n===Vc)return r.LUMINANCE;if(n===Wc)return r.LUMINANCE_ALPHA;if(n===Fi)return r.DEPTH_COMPONENT;if(n===Wi)return r.DEPTH_STENCIL;if(n===pa)return r.RED;if(n===fa)return r.RED_INTEGER;if(n===$c)return r.RG;if(n===ma)return r.RG_INTEGER;if(n===ga)return r.RGBA_INTEGER;if(n===lr||n===cr||n===dr||n===hr)if(o===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===lr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===cr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===lr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===cr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===hr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===To||n===Ao||n===Ro||n===Co)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===To)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ao)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ro)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Co)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Po||n===Lo||n===Io)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Po||n===Lo)return o===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Io)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Do||n===No||n===Fo||n===Uo||n===Oo||n===ko||n===Bo||n===zo||n===Ho||n===Go||n===Vo||n===Wo||n===$o||n===Xo)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Do)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===No)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Fo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Uo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Oo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ko)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Bo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===zo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ho)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Go)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Vo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Wo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===$o)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xo)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ur||n===qo||n===jo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===ur)return o===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===qo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===jo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Xc||n===Yo||n===Ko||n===Zo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ur)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Yo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ko)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Zo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Vi?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}class Ig extends Ot{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Lt extends dt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Dg={type:"move"};class Qr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Lt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Lt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Lt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const g=t.getJointPose(_,n),f=this._getHandJoint(c,_);g!==null&&(f.matrix.fromArray(g.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=g.radius),f.visible=g!==null}const d=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],u=d.position.distanceTo(h.position),p=.02,m=.005;c.inputState.pinching&&u>p+m?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&u<=p-m&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Dg)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Lt;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Ng=`
void main() {
      ...
      `}),n=new H(e,t);this.group.add(n)}_buildSkyline(){this._buildBuildingRing(32,30,.75),this._buildBuildingRing(44,22,.35)}_buildBuildingRing(e,t,n){const i=(s,o)=>s+Math.random()*(o-s);for(let s=0;s<t;s++){const o=s/t*Math.PI*2+i(-.1,.1),a=e+i(-4,4),l=Math.cos(o)*a,c=Math.sin(o)*a,d=i(2.5,6.5),h=i(2,5),u=i(6,28),p=i(.58,.68),m=new ne({color:new Q().setHSL(p,.1,i(.03,.07)),roughness:.7,metalness:.4,transparent:!0,opacity:n}),_=new Te(d,u,h),g=new H(_,m);if(g.position.set(l,u/2,c),g.rotation.y=o+i(-.3,.3),this.group.add(g),Math.random()>.35){const x=new Te(d*.35,i(.5,2.5),h*.35),v=new ne({color:526354,roughness:.5,metalness:.5,transparent:!0,opacity:n}),C=new H(x,v);C.position.set(l,u+i(.3,1.2),c),this.group.add(C)}if(u>20&&Math.random()>.4){const x=new ht(.025,.025,i(2.5,5),4),v=new ne({color:5592422,metalness:.8}),C=new H(x,v);C.position.set(l,u+i(1.2,2.5),c),this.group.add(C);const w=new bt(16720418,.4,10);w.position.set(l,u+i(2.5,5),c),this.group.add(w)}const f=[1122884,1716309,1583176,2241365,2759216,1714240],y=Math.floor(u/1.8);for(let x=0;x<y;x++){if(Math.random()>.6)continue;const v=f[Math.floor(Math.random()*f.length)],C=Math.random()>.25,w=new ne({color:v,emissive:new Q(C?v:263176),emissiveIntensity:C?i(.3,.8):.02,roughness:.1,transparent:!0,opacity:n+.15}),A=Math.floor(d/1.1);for(let R=0;R<A;R++){if(Math.random()>.65)continue;const S=new Mt(.45,.55),M=new H(S,w),P=(x+.5)*1.8,z=(R-(A-1)/2)*1.05;M.position.set(l+Math.cos(o)*(h/2+.02)+Math.sin(o)*z*.3,P,c+Math.sin(o)*(h/2+.02)-Math.cos(o)*z*.3),M.lookAt(0,P,0),this.group.add(M)}}if(u>16&&Math.random()>.6){const x=[3368703,16724838,3407786,16746547][Math.floor(Math.random()*4)],v=new ne({color:x,emissive:new Q(x),emissiveIntensity:.5,transparent:!0,opacity:n*.7}),C=new Te(d+.05,.06,.06),w=new H(C,v);w.position.set(l,u,c-h/2),w.rotation.y=o,this.group.add(w)}}}_buildStars(){const t=new Float32Array(1500),n=new Float32Array(500*3);for(let a=0;a<500;a++){const l=Math.random()*Math.PI*2,c=Math.random()*Math.PI*.4,d=80+Math.random()*15;t[a*3]=d*Math.sin(c)*Math.cos(l),t[a*3+1]=d*Math.cos(c)+12,t[a*3+2]=d*Math.sin(c)*Math.sin(l);const h=Math.random();h>.8?(n[a*3]=.7,n[a*3+1]=.8,n[a*3+2]=1):h>.6?(n[a*3]=1,n[a*3+1]=.95,n[a*3+2]=.8):(n[a*3]=.9,n[a*3+1]=.9,n[a*3+2]=.95)}const i=new _t;i.setAttribute("position",new pt(t,3)),i.setAttribute("color",new pt(n,3));const s=new ws({size:.18,transparent:!0,opacity:.7,sizeAttenuation:!0,vertexColors:!0}),o=new vr(i,s);this.group.add(o)}_buildGroundFog(){const e=new qi(18,55,64,1),t=new on({color:855322,transparent:!0,opacity:.4,side:It}),n=new H(e,t);n.rotation.x=-Math.PI/2,n.position.y=.03,this.group.add(n);const i=new qi(15,24,48,1),s=new on({color:1381672,transparent:!0,opacity:.2,side:It}),o=new H(i,s);o.rotation.x=-Math.PI/2,o.position.y=.5,this.group.add(o)}_buildStreetLights(){const e=new ne({color:4473941,metalness:.7,roughness:.25}),t=14,n=22;for(let i=0;i<t;i++){const s=i/t*Math.PI*2,o=Math.cos(s)*n,a=Math.sin(s)*n,l=new H(new ht(.035,.045,3.5,6),e);l.position.set(o,1.75,a),this.group.add(l);const c=new H(new Te(.7,.025,.025),e);c.position.set(o-Math.cos(s)*.35,3.5,a-Math.sin(s)*.35),this.group.add(c);const d=new ne({color:16772812,emissive:new Q(16768426),emissiveIntensity:.9}),h=new H(new ht(.07,.11,.05,8),d);h.position.set(o-Math.cos(s)*.65,3.48,a-Math.sin(s)*.65),this.group.add(h);const u=new bt(16768426,.35,10);u.position.set(o-Math.cos(s)*.65,3.4,a-Math.sin(s)*.65),this.group.add(u)}}}class U_{constructor(e){this.scene=e,this._systems=[]}spawnFundraiseEffect(e){const n=new _t,i=new Float32Array(120),s=new Float32Array(120),o=[],a=[new Q(15774761),new Q(16766720),new Q(16753920),new Q(16769126)];for(let d=0;d<40;d++){i[d*3]=e.x+(Math.random()-.5)*2,i[d*3+1]=e.y+3+Math.random()*2.5,i[d*3+2]=e.z+(Math.random()-.5)*2;const h=a[Math.floor(Math.random()*a.length)];s[d*3]=h.r,s[d*3+1]=h.g,s[d*3+2]=h.b,o.push({x:(Math.random()-.5)*.03,y:-.015-Math.random()*.025,z:(Math.random()-.5)*.03})}n.setAttribute("position",new pt(i,3)),n.setAttribute("color",new pt(s,3));const l=new ws({size:.18,transparent:!0,opacity:1,vertexColors:!0,sizeAttenuation:!0}),c=new vr(n,l);this.scene.add(c),this._systems.push({points:c,velocities:o,life:2.5,maxLife:2.5})}spawnGrowthEffect(e){const n=new _t,i=new Float32Array(75),s=new Float32Array(75),o=[],a=[new Q(2278750),new Q(4906624),new Q(1096065),new Q(8843180)];for(let d=0;d<25;d++){i[d*3]=e.x+(Math.random()-.5)*.5,i[d*3+1]=e.y+1,i[d*3+2]=e.z+(Math.random()-.5)*.5;const h=a[Math.floor(Math.random()*a.length)];s[d*3]=h.r,s[d*3+1]=h.g,s[d*3+2]=h.b,o.push({x:(Math.random()-.5)*.05,y:.04+Math.random()*.04,z:(Math.random()-.5)*.05})}n.setAttribute("position",new pt(i,3)),n.setAttribute("color",new pt(s,3));const l=new ws({color:2278750,size:.12,transparent:!0,opacity:1,vertexColors:!0,sizeAttenuation:!0}),c=new vr(n,l);this.scene.add(c),this._systems.push({points:c,velocities:o,life:2,maxLife:2})}update(e){for(let t=this._systems.length-1;t>=0;t--){const n=this._systems[t];if(n.life-=e,n.life<=0){this.scene.remove(n.points),n.points.geometry.dispose(),n.points.material.dispose(),this._systems.splice(t,1);continue}const i=n.points.geometry.getAttribute("position");for(let o=0;o<n.velocities.length;o++)i.array[o*3]+=n.velocities[o].x,i.array[o*3+1]+=n.velocities[o].y,i.array[o*3+2]+=n.velocities[o].z,n.velocities[o].y*=.995;i.needsUpdate=!0;const s=n.life/n.maxLife;n.points.material.opacity=s*s,n.points.material.size=.1+s*.1}}}const wd={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Zi.BlurDirectionX=new _e(1,0);Zi.BlurDirectionY=new _e(0,1);const W_={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    `).join(""),j=(i.seven_dimension_scores||{}).dimensions||{},W=Object.keys(j).length>0?Object.entries(j).map(([se,ae])=>{const Ee=Math.round(Number(ae)||0),Pe=se.replace(/_/g," "),Oe=Ee>=70?"#34D058":Ee>=40?"#FFB800":"#EF4444";return`
      ...
      <div class="stat-grid">
        ...
        <div class="stat-cell">
          ...
          <div class="stat-value" style="color:${(i.runway||0)<4?"#EF4444":(i.runway||0)<7?"#FB923C":"#34D058"}">${C_(i.runway)}</div>
        </div>
        <div class="stat-cell">
          <div class="stat-label">Users</div>
          <div class="stat-value" style="color:#22D3EE">${R_(i.users)}</div>
        </div>
        <div class="stat-cell">
...
`)}}showPostGame(e={}){var m;const t=this.store.state.gameData;if(!t)return;const n=Er(t),i=Cs(t),s=t.summary||{},o=this.store.getShareUrl(),a=this._buildSharePackage(t,s,i,n),c=(e.entryMode||null)==="sharedReplay",d=i[0],h=i.slice(0,3),u=n?`${mt(Dn(d))} score`:uo(d==null?void 0:d.valuation),p=n?`${uo(d==null?void 0:d.valuation)} valuation`:`${(d==null?void 0:d.sector)||""}`;this._modal.innerHTML=`
    ...
    `,this.container.appendChild(this._header),this._matchStrip=document.createElement("div"),this._matchStrip.className="match-strip hidden",this.container.appendChild(this._matchStrip),this._spectatorEntry=document.createElement("div"),this._spectatorEntry.className="spectator-entry hidden",this.container.appendChild(this._spectatorEntry),this._featuredReplayPage=document.createElement("div"),this._featuredReplayPage.className="spectator-entry hidden",this.container.appendChild(this._featuredReplayPage),this._featuredSlotPage=document.createElement("div"),this._featuredSlotPage.className="spectator-entry hidden",this.container.appendChild(this._featuredSlotPage),this._discoveryShelf=document.createElement("div"),this._discoveryShelf.className="spectator-entry hidden",this.container.appendChild(this._discoveryShelf),this._statusEl=this._header.querySelector("#header-status"),this._header.querySelector("#btn-quick-play").addEventListener("click",()=>{this.controls.quickPlayVsBots()}),this._header.querySelector("#btn-new-game").addEventListener("click",()=>{this.controls.showCreateGame()}),this._header.querySelector("#btn-watch").addEventListener("click",()=>{this.controls.showJoinExisting()})}_formatDelta(e){const t=Number(e||0);return Math.abs(t)<.05?"Flat":`${t>0?"+":""}${t.toFixed(1)}`}_pressurePills(e){return((e==null?void 0:e.risk_tags)||[]).slice(0,2).map(n=>`<span class="signal-pill signal-pill-${n.tone||"neutral"}">${n.label||n}</span>`).join("")}_runnerAlertTone(e){return{error:"danger",warn:"warning",info:"neutral"}[e==null?void 0:e.severity]||"neutral"}_copyButtonFeedback(e,t,n){e&&(e.textContent=n,clearTimeout(e._copyTimer),e._copyTimer=setTimeout(()=>{e.textContent=t},1500))}_isFeaturedReplayPage(e){var t,n,i,s;return!!((t=e.entryContext)!=null&&t.viaSharedLink&&((n=e.entryContext)==null?void 0:n.requestedPhase)==="replay"&&((i=e.gameData)==null?void 0:i.phase)==="finished"&&((s=e.gameData)!=null&&s.summary))}_isReplayCardLayout(e){var t;return this._isFeaturedReplayPage(e)&&((t=e.entryContext)==null?void 0:t.layout)==="card"}_isFeaturedSlotPage(e){var t;return!!(!e.gameId&&((t=e.entryContext)!=null&&t.slot)&&e.featuredFeed)}_slotTitle(e){return String(e||"").replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}_buildReplayEmbedSnippet(e,t="Founder Arena Featured Replay"){return e?`<iframe src="${e}" title="${t}" width="720" height="900" style="width:100%;max-width:720px;height:900px;border:0;border-radius:16px;overflow:hidden;" loading="lazy"></iframe>`:""}_syncReplayLayoutChrome(e){const t=this._isFeaturedReplayPage(e),n=this._isReplayCardLayout(e),i=this._isFeaturedSlotPage(e),s=t||i;this.rankings.el.style.display=s?"none":"",this.timeline._wrapper.style.display=s?"none":"",this.detail.el.style.display=s?"none":"";const o=this._header.querySelector("#btn-quick-play"),a=this._header.querySelector("#btn-new-game"),l=this._header.querySelector("#btn-watch");[o,a,l].forEach(c=>{c&&(c.style.display=n?"none":"")})}_updateDiscoveryShelf(e){if(!!(e.gameId||e.gameData)||this._isFeaturedSlotPage(e)){this._discoveryShelf.classList.add("hidden"),this._discoveryShelf.innerHTML="";return}const n=Array.isArray(e.games)?e.games:[],i=e.leaderboardData||{},s=e.featuredFeed||{},o=(s.live_now||[]).length>0?s.live_now:n.filter(m=>m.phase==="playing").sort((m,_)=>(_.turn||0)-(m.turn||0)).slice(0,3),a=(s.featured_replays||[]).length>0?(s.featured_replays||[]).slice(0,4):[];if(a.length===0){for(const m of i.leaderboard||[])if(!(m.game_mode!=="competitive_mode"||!m.was_winner)&&!a.some(_=>_.game_id===m.game_id)&&(a.push(m),a.length>=4))break}const l=(i.agent_rankings||[]).slice(0,5),c=[{label:"Daily Featured Duel",accent:"#FFB800",item:s.daily_featured_duel,mode:"slot",slot:"daily_featured_duel"},{label:"Weekly Upset Recap",accent:"#A78BFA",item:s.weekly_upset_recap,mode:"slot",slot:"weekly_upset_recap"},{label:"Beat This Benchmark",accent:"#22D3EE",item:s.benchmark_challenge,mode:"slot",slot:"benchmark_challenge"}];if(o.length===0&&a.length===0&&l.length===0&&!c.some(m=>m.item)){this._discoveryShelf.classList.add("hidden"),this._discoveryShelf.innerHTML="";return}const d=o.length>0?o.map(m=>`
        ...
        <button class="btn-clean discovery-link" data-mode="${m.mode}" data-slot="${m.slot}" data-game="${m.item.game_id}" data-spectator="${m.item.spectator_token||""}" style="text-align:left;padding:12px 14px;border-color:${m.accent}2e;background:${m.accent}12">
    ...
    `;const _=this._featuredReplayPage.querySelector("#featured-open-recap"),g=this._featuredReplayPage.querySelector("#featured-copy-link"),f=this._featuredReplayPage.querySelector("#featured-copy-card-link"),y=this._featuredReplayPage.querySelector("#featured-copy-embed"),x=this._featuredReplayPage.querySelector("#featured-copy-headline"),v=this._featuredReplayPage.querySelector("#featured-copy-caption"),C=this._featuredReplayPage.querySelector("#featured-copy-package"),w=this._featuredReplayPage.querySelector("#featured-copy-recap");_==null||_.addEventListener("click",()=>{this.controls.showPostGame({entryMode:"sharedReplay"})}),g==null||g.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(c||""),this._copyButtonFeedback(g,"Copy Link","Link Copied")}catch{this._copyButtonFeedback(g,"Copy Link","Copy Failed")}}),f==null||f.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(d||""),this._copyButtonFeedback(f,"Copy Card Link","Card Link Copied")}catch{this._copyButtonFeedback(f,"Copy Card Link","Copy Failed")}}),y==null||y.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(p||""),this._copyButtonFeedback(y,"Copy Embed","Embed Copied")}catch{this._copyButtonFeedback(y,"Copy Embed","Copy Failed")}}),x==null||x.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.headline||""),this._copyButtonFeedback(x,"Copy Headline","Headline Copied")}catch{this._copyButtonFeedback(x,"Copy Headline","Copy Failed")}}),v==null||v.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.caption||""),this._copyButtonFeedback(v,"Copy Caption","Caption Copied")}catch{this._copyButtonFeedback(v,"Copy Caption","Copy Failed")}}),C==null||C.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.featuredCard||""),this._copyButtonFeedback(C,"Copy Package","Package Copied")}catch{this._copyButtonFeedback(C,"Copy Package","Copy Failed")}}),w==null||w.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(u||""),this._copyButtonFeedback(w,"Copy Recap","Recap Copied")}catch{this._copyButtonFeedback(w,"Copy Recap","Copy Failed")}}),this._featuredReplayPage.querySelectorAll(".featured-replay-select").forEach(R=>{R.addEventListener("click",()=>{var M,P;const S=R.dataset.id;S&&(this.store.selectStartup(S),(P=(M=this.scene)==null?void 0:M.focusOnPod)==null||P.call(M,S))})})}_updateFeaturedSlotPage(e){var g;if(!this._isFeaturedSlotPage(e)){this._featuredSlotPage.classList.add("hidden"),this._featuredSlotPage.innerHTML="";return}const t=(g=e.entryContext)==null?void 0:g.slot,n=e.featuredFeed||{},i=(n==null?void 0:n[t])||null,s=this._slotTitle(t),o=this.store.getFeaturedSlotUrl(t);if(this._featuredSlotPage.classList.remove("hidden"),!i){this._featuredSlotPage.innerHTML=`
      ...
      `;return}const a=`${window.location.origin}${window.location.pathname}?game=${encodeURIComponent(i.game_id)}${i.spectator_token?`&spectator=${encodeURIComponent(i.spectator_token)}`:""}&phase=replay`,l=`${a}&layout=card`,c=this._buildReplayEmbedSnippet(l,`${s} | Founder Arena`);this._featuredSlotPage.innerHTML=`
      <div class="spectator-entry-card spectator-entry-card-replay" style="padding:18px 20px;max-width:960px;margin:0 auto;background:
        ...
        <div class="spectator-entry-hero" style="align-items:flex-start">
          <div style="flex:1 1 520px;min-width:0">
            ...
            <div class="spectator-entry-headline" style="font-size:28px;line-height:1.15;margin-top:8px">${i.headline||`${i.winner_startup} won the slot`}</div>
...
`)}</div>
          ...
          <div style="display:grid;gap:16px">
            ...
            <div style="padding:14px 16px;border-radius:14px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06)">
              ...
              <div style="font-size:10px;color:var(--text-dim);line-height:1.6;word-break:break-word;margin-top:10px">${o}</div>
            </div>
          </div>
        </div>
      </div>
    `;const d=this._featuredSlotPage.querySelector("#slot-open-replay"),h=this._featuredSlotPage.querySelector("#slot-open-card"),u=this._featuredSlotPage.querySelector("#slot-copy-slot-link"),p=this._featuredSlotPage.querySelector("#slot-copy-replay-link"),m=this._featuredSlotPage.querySelector("#slot-copy-card-link"),_=this._featuredSlotPage.querySelector("#slot-copy-embed");d==null||d.addEventListener("click",()=>{this.store.watchGame(i.game_id,i.spectator_token||null,{viaSharedLink:!0,requestedPhase:"replay",slot:t})}),h==null||h.addEventListener("click",()=>{this.store.watchGame(i.game_id,i.spectator_token||null,{viaSharedLink:!0,requestedPhase:"replay",layout:"card",slot:t})}),u==null||u.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(o),this._copyButtonFeedback(u,"Copy Slot Link","Slot Link Copied")}catch{this._copyButtonFeedback(u,"Copy Slot Link","Copy Failed")}}),p==null||p.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),this._copyButtonFeedback(p,"Copy Replay Link","Replay Link Copied")}catch{this._copyButtonFeedback(p,"Copy Replay Link","Copy Failed")}}),m==null||m.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(l),this._copyButtonFeedback(m,"Copy Card Link","Card Link Copied")}catch{this._copyButtonFeedback(m,"Copy Card Link","Copy Failed")}}),_==null||_.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(c),this._copyButtonFeedback(_,"Copy Embed","Embed Copied")}catch{this._copyButtonFeedback(_,"Copy Embed","Copy Failed")}})}_updateSpectatorEntry(e){var y,x,v;const t=e.entryContext||{},n=e.gameData;if(!t.viaSharedLink){this._spectatorEntry.classList.add("hidden"),this._matchStrip.classList.remove("match-strip-with-entry"),this._matchStrip.classList.remove("match-strip-with-replay-entry"),this._spectatorEntry.innerHTML="";return}if(this._isFeaturedReplayPage(e)){this._spectatorEntry.classList.add("hidden"),this._matchStrip.classList.remove("match-strip-with-entry"),this._matchStrip.classList.remove("match-strip-with-replay-entry"),this._spectatorEntry.innerHTML="";return}const i=(n==null?void 0:n.phase)||e.view,s=t.requestedPhase==="replay",o=s&&i==="finished"&&(n==null?void 0:n.summary),a=s||i==="finished"?"Replay Link":"Watch Link",l=o?null:i==="finished"?((y=n==null?void 0:n.summary)==null?void 0:y.winner_summary)||"Replay recap is loading.":i==="playing"?((x=n==null?void 0:n.live_summary)==null?void 0:x.why_ahead)||"Live match context is loading.":i==="lobby"?"Shared lobby link opened. Waiting for the match to start.":"Connecting to shared match link.",c=n?`${n.name||"Founder Arena"} · ${n.queue||"showmatch"} · ${n.benchmark_tier||"baseline"}`:`Game ${e.gameId||""}`,d=n?`${i==="finished"?"Final replay":i==="playing"?`Week ${n.turn||0}/${n.max_turns||32}`:"Pre-match"}`:"Connecting",h=this.store.startupList||[],u=(n==null?void 0:n.summary)||{},p=h[0]||null,m=(u.turning_points||[])[0]||null,_=o?this.controls._buildSharePackage(n,u,h,(n==null?void 0:n.rank_basis)==="score"):null,g=o?this.store.getShareUrl():"",f=(_==null?void 0:_.formatLabel)||a;if(this._spectatorEntry.classList.remove("hidden"),this._matchStrip.classList.add("match-strip-with-entry"),this._matchStrip.classList.toggle("match-strip-with-replay-entry",!!o),this._spectatorEntry.innerHTML=`
      <div class="spectator-entry-card">
        <div class="spectator-entry-topline">
