...
class BalanceHarnessTests(unittest.TestCase):
    ...
    def test_seeded_tournament_reports_expected_balance_metrics(self) -> None:
        ...
        self.assertIn("phase_profiles", summary)
        self.assertIn("phase_profile_deltas", summary)
        ...
        self.assertIn("field", summary["phase_profiles"])
        self.assertIn("archetypes", summary["phase_profiles"])
        self.assertIn("opening", summary["phase_profiles"]["field"])
        self.assertIn("aggressive", summary["phase_profiles"]["archetypes"])
        self.assertIn("aggressive", summary["phase_profile_deltas"])
        opening_field = summary["phase_profiles"]["field"]["opening"]
        opening_aggressive = summary["phase_profiles"]["archetypes"]["aggressive"]["opening"]
        opening_aggressive_delta = summary["phase_profile_deltas"]["aggressive"]["opening"]
        self.assertIn("samples", opening_field)
        self.assertIn("avg_score_delta", opening_field)
        self.assertIn("avg_users_delta", opening_field)
        self.assertIn("avg_product_quality_delta", opening_field)
        self.assertIn("avg_action_usage_per_phase", opening_field)
        self.assertIn("action_family_avg_per_phase", opening_field)
        self.assertIn("action_family_share", opening_field)
        self.assertIn("action_usage", opening_aggressive)
        self.assertIn("avg_brand_delta", opening_aggressive)
        self.assertIn("avg_team_size_delta", opening_aggressive)
        self.assertIn("avg_score_delta", opening_aggressive_delta)
        self.assertIn("avg_cash_delta", opening_aggressive_delta)
        self.assertIn("action_family_share", opening_aggressive_delta)
        self.assertIn("action_family_avg_per_phase", opening_aggressive_delta)
