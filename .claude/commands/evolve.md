...
### Learned Rules
!`cat C:/Users/USER/Desktop/founder-arena/.claude/memory/learned-rules.md 2>/dev/null || echo "No learned rules yet"`

### Recent Corrections (last 20)
!`tail -20 C:/Users/USER/Desktop/founder-arena/.claude/memory/corrections.jsonl 2>/dev/null || echo "No corrections logged"`

### Recent Observations (last 20)
!`tail -20 C:/Users/USER/Desktop/founder-arena/.claude/memory/observations.jsonl 2>/dev/null || echo "No observations logged"`

### Previous Evolution Decisions
!`tail -40 C:/Users/USER/Desktop/founder-arena/.claude/memory/evolution-log.md 2>/dev/null || echo "No evolution history"`
